...
function jvcf7_pro_notification(){
	if (get_option('jvcf7_hide_email_checker_notice') != 'yes_6'){
       ...
       <p><b>Deliverability Email Validation Plugin</b></p>
	   <p>
	   Allow only real email address to pass the validation. Deliverability Email checker is advance email validation rules that can detect only genuine and deliverable email addresses. No more spam email submission.</p><p>
	   Click <a href="https://bit.ly/3beghuK" target="_blank"><strong>HERE</strong></a> for demo<br/><a style="display:block;text-align:right;" href="admin.php?page=jvcf7_settings_page&hidemsg_emailchecker=1">Hide This Message</a></p>
	   </div>';
	}
