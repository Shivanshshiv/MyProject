                ...
                if (!empty($acfs)) {
                        ...
                        foreach ($acfs as $key => $acf) {
                                ...
                                if (!empty($group_id) && is_numeric($group_id)) {
                                        ...
                                        $acf_fields = get_posts(array('posts_per_page' => -1, 'post_type' => 'acf-field', 'post_parent' => $group_id, 'post_status' => 'publish', 'orderby' => 'menu_order', 'order' => 'ASC'));
                                        ...
                                        if (!empty($acf_fields)) {
                                                ...
                                                foreach ($acf_fields as $field) {
                                                        ...
                                                        if (!empty($field_type) && in_array($field_type, ["group", "clone", "flexible_content", "repeater"])) {
                                                ...
                                                case 'repeater':
                                                        ...
                                                        if (!empty($sub_fields)) {
                                                                ...
                                                                foreach ($sub_fields as $s_key => $s_field) {
                                                                        ...
                                                                        if (!empty($new_field)) {
                                                                                $field_list[] = ["key" => $name . "_" . $s_key . "_" . $new_field, "regexp" => "/^" . $name . "_.*_" . $new_field . "$/"];
                                                                        }
                                                                }
                                                        }
                                        ...
                                        case 'relationship':
                                                ...
                                                if (is_array($value)) {
                                                        ...
                                                        foreach ($value as $key => $pid) {
                                                                ...
                                                                if ($entry) {
                                                                        $rel[] = $entry->post_title;
                                                                }
                                                                unset($entry);
                                                        }

                                                        $value = implode($delimiter, $rel);
