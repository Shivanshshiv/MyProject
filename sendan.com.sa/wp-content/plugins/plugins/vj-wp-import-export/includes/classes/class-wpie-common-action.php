...
class WPIE_Common_Actions {
    ...
    public function wpie_get_templates() {
        ...
        $results = $wpdb->get_results("SELECT * FROM " . $wpdb->prefix . "wpie_template where `opration` = 'import_template' or `opration` = 'export_template'");
    ...
    public function wpie_delete_tempaltes() {
        ...
        $return_value['message'] = __('Templates Successfully Deleted', 'vj-wp-import-export');
                ...
                if (!empty($template_data)) {
                    ...
                    if (!empty($template_data)) {
                        ...
                        if ($wpdb->query($wpdb->prepare("$query ", $values))) {
                            ...
                            $return_value['message'] = __('Error when insert to database', 'vj-wp-import-export');
                        }
