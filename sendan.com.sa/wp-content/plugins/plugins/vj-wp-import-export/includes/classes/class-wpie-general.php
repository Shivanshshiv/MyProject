...
class WPIE_General {
    ...
    public static function plugin_action_links($links = array()) {
        ...
        $plugin_links = [
                '<a href="' . admin_url("admin.php?page=wpie-new-export") . '">' . esc_html__('Import', 'vj-wp-import-export') . '</a>',
                '<a href="' . admin_url("admin.php?page=wpie-new-import") . '">' . esc_html__('Export', 'vj-wp-import-export') . '</a>',
        ];
    ...
    private static function wpie_load_msg() {
        return array(
                ...
                "wpieUploadFromURLText" => __('File Upload From URL', 'vj-wp-import-export'),
                "wpieUploadFromFTPText" => __('File Upload From FTP', 'vj-wp-import-export'),
                ...
                "wpieEmptyLicenseKey" => __("License Key is empty", 'vj-wp-import-export'),
