            ...
            <div class="wpie_field_mapping_container_data">
                <div class="wpie_product_data_section">
                    ...
                    <div class="wpie_product_menu_wrapper">
                        ...
                        <div class="wpie_product_menu_list wpie_product_menu_extra" display_block="wpie_product_extra_wrapper"><?php esc_html_e('Plugin Extra Option', 'vj-wp-import-export'); ?></div>
                    </div>
                    <div class="wpie_product_content_wrapper">
                        ...
                        <div class="wpie_product_data_container wpie_product_attributes_wrapper">
                            <div class="wpie_product_element_data_container wpie_attr_data_wrapper">
                                <div class="wpie_product_element_wrapper  ">
                                    <div class="wpie_product_attr_data wpie_product_attr_data_label"><?php echo esc_html_e('Name', 'vj-wp-import-export'); ?></div>
                                    <div class="wpie_product_attr_data wpie_product_attr_data_label">
                                        ...
                                        <div class="wpie_product_element_wrapper">
                                            <div class="wpie_product_attr_data">
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                    ...
                                                    <label for="wpie_attr_in_variations_yes_0" class="wpie_radio_label wpie_attr_in_variations"><?php esc_html_e('Used for variations', 'vj-wp-import-export'); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper ">
                                                    ...
                                                    <label for="wpie_attr_in_variations_no_0" class="wpie_radio_label wpie_attr_in_variations"><?php esc_html_e('Not Used for Variations', 'vj-wp-import-export'); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                    ...
                                                    <label for="wpie_attr_in_variations_as_specified_0" class="wpie_radio_label wpie_attr_in_variations wpie_attr_in_variations_as_specified"><?php esc_html_e('As specified', 'vj-wp-import-export'); ?></label>
                                                    <div class="wpie_radio_container wpie_as_specified_wrapper">
                                            ...
                                            <div class="wpie_product_attr_data">
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                    ...
                                                    <label for="wpie_attr_is_visible_yes_0" class="wpie_radio_label"><?php esc_html_e('Is Visible', 'vj-wp-import-export'); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper ">
                                                    <input type="radio" class="wpie_radio wpie_attr_is_visible" name="wpie_attr_is_visible[0]" id="wpie_attr_is_visible_no_0" value="no"/>
                                                    <label for="wpie_attr_is_visible_no_0" class="wpie_radio_label"><?php esc_html_e('Not Visible', 'vj-wp-import-export'); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                    ...
                                                    <label for="wpie_attr_is_visible_as_specified_0" class="wpie_radio_label"><?php esc_html_e('As specified', 'vj-wp-import-export'); ?></label>
                                                    <div class="wpie_radio_container wpie_as_specified_wrapper">
                                        ...
                                        <div class="wpie_product_element_wrapper">
                                            <div class="wpie_product_attr_data">
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                    ...
                                                    <label for="wpie_attr_is_taxonomy_yes_0" class="wpie_radio_label"><?php esc_html_e('Is Taxonomy', 'vj-wp-import-export'); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper ">
                                                    ...
                                                    <label for="wpie_attr_is_taxonomy_no_0" class="wpie_radio_label"><?php esc_html_e('Not Taxonomy', 'vj-wp-import-export'); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                    ...
                                                    <label for="wpie_attr_is_taxonomy_as_specified_0" class="wpie_radio_label"><?php esc_html_e('As specified', 'vj-wp-import-export'); ?></label>
                                                    <div class="wpie_radio_container wpie_as_specified_wrapper">
                                            ...
                                            <div class="wpie_product_attr_data">
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                    ...
                                                    <label for="wpie_attr_is_auto_create_term_yes_0" class="wpie_radio_label"><?php esc_html_e('Auto-Create Terms', 'vj-wp-import-export'); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper ">
                                                    ...
                                                    <label for="wpie_attr_is_auto_create_term_no_0" class="wpie_radio_label"><?php esc_html_e('Do Not Create Terms', 'vj-wp-import-export'); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                    ...
                                                    <label for="wpie_attr_is_auto_create_term_as_specified_0" class="wpie_radio_label"><?php esc_html_e('As specified', 'vj-wp-import-export'); ?></label>
                                                    <div class="wpie_radio_container wpie_as_specified_wrapper">
                            ...
                            <div class="wpie_product_element_data_container">
                                <div class="wpie_product_element_wrapper">
                                    <div class="wpie_field_mapping_other_option_wrapper ">
                                        ...
                                        <label class="wpie_checkbox_label" for="wpie_item_meta_disable_auto_sku"><?php esc_html_e('Disable auto SKU generation', 'vj-wp-import-export'); ?></label>
                                        <i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e("Plugin will NOT automatically generate the SKU for each product, if SKU option is empty.", "vj-wp-import-export"); ?>"></i>
                                    </div>
                                </div>
                            </div>
