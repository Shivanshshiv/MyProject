        ...
        <div class="wpie_field_mapping_container_wrapper">
            ...
            <div class="wpie_field_mapping_container_data">
                <div class="wpie_field_mapping_container_element">
                    ...
                    <?php if (!empty($wpie_langs)) { ?>
                        <?php foreach ($wpie_langs as $code => $langInfo) { ?>
                            <div class="wpie_field_mapping_other_option_wrapper">
                                <input type="radio" class="wpie_radio wpie_wpml_lang wpie_wpml_lang_<?php echo esc_attr($code); ?>" checked="checked" name="wpie_wpml_lang_code" id="<?php echo esc_attr($random . '_wpml_lang_' . $code); ?>" value="<?php echo esc_attr($code); ?>"/>
                    ...
                    <?php } ?>
                    <div class="wpie_field_mapping_other_option_wrapper">
                        <input type="radio" class="wpie_radio wpie_field_mapping_other_option_radio wpie_wpml_lang wpie_wpml_lang_as_specified" name="wpie_wpml_lang_code" checked="checked" id="wpie_wpml_lang_as_specified" value="as_specified"/>
                        <label for="wpie_wpml_lang_as_specified" class="wpie_radio_label"><?php esc_html_e('As specified', 'vj-wp-import-export'); ?></label>
