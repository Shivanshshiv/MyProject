            ...
            <div class="wpie_field_mapping_container_data">
                <div class="wpie_product_data_section">
                    <div class="wpie_product_menu_wrapper">
                        ...
                        <div class="wpie_order_item_list wpie_product_menu_inventory" display_block="wpie_order_shipping_wrapper"><?php esc_html_e('Shipping', 'vj-wp-import-export'); ?></div>
                        <div class="wpie_order_item_list wpie_product_menu_shipping" display_block="wpie_order_payment_wrapper" ><?php esc_html_e('Payment', 'vj-wp-import-export'); ?></div>                        
                    </div>
                            ...
                            <div class="wpie_product_element_data_container">
                                <div class="wpie_product_element_wrapper">
                                    <div class="wpie_element_half_wrapper">
                                        <div class="wpie_product_element_data_lable"><?php echo esc_html_e('Meta Name', 'vj-wp-import-export'); ?></div>
                                    </div>
                                    <div class="wpie_element_half_wrapper">
                                        <div class="wpie_product_element_data_lable"><?php echo esc_html_e('Meta Value', 'vj-wp-import-export'); ?></div>
                                    </div>
                                </div>
