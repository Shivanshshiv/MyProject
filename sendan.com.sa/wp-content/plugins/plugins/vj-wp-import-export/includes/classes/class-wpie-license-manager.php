...
class WPIE_License_Manager {
        ...
        function modify_plugin_update_message($plugin_data, $response) {
                ...
                echo '<br />' . sprintf(__('To enable updates, please enter your license key on the <a href="%s">Updates</a> page.', 'vj-wp-import-export'), admin_url('admin.php?page=wpie-settings'));
        }
        ...
        private function update_license($key = '') {
        ...
        public function wpie_change_license_status() {
                ...
                if ($status == "activate") {
                        ...
                        if ($is_active === true) {
                                wp_send_json_success(__('License Successfully Activated', 'vj-wp-import-export'));
                        ...
                        if ($is_deactive === true) {
                                wp_send_json_success(__('License Successfully Deactivated', 'vj-wp-import-export'));
        ...
        private function activate_license($license = "") {
                ...
                if (empty($license)) {
                        ...
                        return new \WP_Error('wpie_empty_field_error', __('Empty License Key', 'vj-wp-import-export'));
                }
                ...
                if ($is_error) {
                        return new \WP_Error('server_error', __('unexpected error occurred while activation of license', 'vj-wp-import-export'));
                }
