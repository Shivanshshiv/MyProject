    ...
    <div class="wpie_content_wrapper">
        <div class="wpie_section_wrapper">
            <div class="wpie_content_data_header">
                <div class="wpie_content_title"><?php esc_html_e('Licenses', 'vj-wp-import-export'); ?></div>
            ...
            <div class="wpie_section_content">
                <div class="wpie_setting_element_wrapper wpie_license_activation_wrapper <?php echo esc_attr($active_class); ?>">
                    <div class="wpie_setting_element_lable"><?php esc_html_e('License Key', 'vj-wp-import-export'); ?></div>
                    <div class="wpie_setting_element_data">
                        ...
                        <div class="wpie_setting_element_hint"><?php esc_html_e('A license key is required to access plugin updates and support.', 'vj-wp-import-export'); ?></div>
                    </div>
                ...
                <div class="wpie_setting_element_wrapper wpie_license_deactivation_wrapper <?php echo esc_attr($deactive_class); ?>">
                    <div class="wpie_setting_element_lable"><?php esc_html_e('License Status', 'vj-wp-import-export'); ?></div>
                    <div class="wpie_setting_element_data">
