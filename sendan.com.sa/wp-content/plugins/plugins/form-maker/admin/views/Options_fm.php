        ...
        <div class="wd-box-section">
          ...
          <div class="wd-box-content">
            ...
            <span class="wd-group">
              ...
              <input <?php var_dump(isset($fm_settings['fm_block_ip_exceeded_limit'])); echo checked($fm_block_ip_exceeded_limit, '1'); ?> id="fm_block_ip_exceeded_limit-1" class="wd-radio" value="1" name="fm_block_ip_exceeded_limit" type="radio"/>
