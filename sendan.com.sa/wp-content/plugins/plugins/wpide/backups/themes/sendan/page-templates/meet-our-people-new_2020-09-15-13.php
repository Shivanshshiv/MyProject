        ...
        <div class="row">
            <div id="businessquato2" class="carousel slide" data-ride="carousel">
                <ol class="carousel-indicators slide-botom">
                                        ...
                                        <li data-target="#businessquato2" data-slide-to="1" ></li> 
                                        <li data-target="#businessquato2" data-slide-to="2" ></li> 
                                        <li data-target="#businessquato2" data-slide-to="3" ></li> 
                                        <li data-target="#businessquato2" data-slide-to="4" ></li> 
                                        <li data-target="#businessquato2" data-slide-to="5" ></li> 
                        	                </ol>
                <div class="carousel-inner ">
                                 
                            <div class="carousel-item active">
                                <img class="img-fluid" src="http://sendanit.com/sendan_web/wp-content/uploads/2020/09/img-2.png" alt="">
                            </div>
                            ...
                            <div class="carousel-item">
                                <img class="img-fluid" src="http://sendanit.com/sendan_web/wp-content/uploads/2020/09/img-5.png" alt="">
                            </div>
                            
                            <div class="carousel-item">
                                <img class="img-fluid" src="http://sendanit.com/sendan_web/wp-content/uploads/2020/09/img-4.pngg" alt="">
                            </div>
                            
                            <div class="carousel-item">
                                <img class="img-fluid" src="http://sendanit.com/sendan_web/wp-content/uploads/2020/09/img-3.png" alt="">
                            </div>
