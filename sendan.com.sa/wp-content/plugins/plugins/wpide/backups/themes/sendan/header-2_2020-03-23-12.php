...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="images/favicon.ico"/>
      ...
      <script src="<?php echo get_template_directory_uri() ?>/assets-2/js/bootstrap.min.js"></script>
