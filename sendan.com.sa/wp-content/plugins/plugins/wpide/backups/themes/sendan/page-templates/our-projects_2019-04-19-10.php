    ...
    <div class="container">
        ...
        <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
			...
			?>
                ...
                <tr>
                    <td><?php echo $sector_types['name'] ?></td>

                    <td><a href="#" data-toggle="modal" data-target="#myModal">Retrofit The Dehydrator Vessel At  SHGOSP-5  With DFD System</a></td>
                    <!-- Modal -->
                        ...
                        <div class="modal-dialog modal-lg">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title"><i class="fa fa-users" aria-hidden="true"></i> Saudi Aramco, HwGOSP</h4>
                                    <button type="button" class="close" data-dismiss="modal">&times;</button>

                                </div>
                                <div class="modal-body"> <img src="img/Maaden-Phosphate-Company-Logo.jpg" class="">
