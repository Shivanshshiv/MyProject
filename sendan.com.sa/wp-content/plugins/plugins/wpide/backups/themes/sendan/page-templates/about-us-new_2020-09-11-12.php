...
<!--Sectors-->
                <div class="carousel-item">
                    <div class="col-md-12 f-left  padd0">
                        <h4 style="font-size: 18px; margin-bottom: 30px;">SENDANs engaged in following sectors.</h4>
                    </div>
                    <div class="col-md-12 f-left padd0">
                    <?php
