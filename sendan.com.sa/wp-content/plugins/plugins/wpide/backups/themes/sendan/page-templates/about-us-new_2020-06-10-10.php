                        ...
                        <div class="col-md-8 f-left text-center">
                            ...
                            <div class="col-md-3 col-6 f-left countermainarea-about">
                                <div class="counter-about">
                                    ...
                                    <span class="timer count-title-about count-number "id="counter_<?php echo $count;?>" data-to="<?php echo the_sub_field('counter_number'); ?>" data-speed="1500"><?php echo the_sub_field('count_number'); ?></span>
