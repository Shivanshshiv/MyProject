        ...
        <div class="row">
            <div class="col-md-12 project-tab padd0" id="tabs">
               ...
               <div class="tab-content tab-main-box " id="nav-tabContent" style="background-color: #ffffffdb;">
                        ...
                        <div class="tab-pane fade show active" id="nav-Arabia" role="tabpanel" aria-labelledby="nav-home-tab">

                            <!----------------------------------------------->

                            <div class="row">
                                <div id="Awards" class="carousel slide" data-ride="carousel" style="width: 100%;">
                                                ...
                                                <div class="col-md-3 f-left">
                                                    <div class="col-md-12 f-left about-award padd0">
                                                        <div class="col-lg-12 thumb onlyaw-img padd0 f-left">
                                                            <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title="" data-caption="" data-image="image/award/aw-1.jpg" data-target="#image-gallery">
                                                                <img class="img-fluid" src="image/award/aw-1.jpg">
                                                            </a>
                                                        </div>
                                                        <div class="col-md-12 f-left about-award-2">
                                                            <h3>Excellence Certificate</h3>
                                                            <p>Outstanding Long Term Partnership</p>
                                                            <h4><b>Client </b>: Atlas Copco</h4>
                                                            <h5><b>Project</b> :Partnership</h5>
                                                            <p><b>Date </b>: 15-09-2019</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <a style="margin-left: -34px; opacity: 1" class="carousel-control-prev" href="#Awards" role="button" data-slide="prev">
                                        <div class="cus-pre">
                                            <img width="10" src="image/left.png">
                                        </div>
                                    </a>
                                    <a style=" margin-right: -34px; opacity: 1" class="carousel-control-next" href="#Awards" role="button" data-slide="next">
                                        <div class="cus-pre">
                        ...
                        <div class="tab-pane fade" id="nav-Emirates" role="tabpanel" aria-labelledby="nav-profile-tab">
                            ...
                            <div class="row">
                                <div id="Awards18" class="carousel slide" data-ride="carousel" style="width: 100%;">
                                        ...
                                        <div class="carousel-item active">
                                            <div class="col-md-12 ">
                                                <div class="col-md-3 f-left">
                                                    <div class="col-md-12 f-left about-award padd0">
                                                        <div class="col-lg-12 thumb onlyaw-img padd0 f-left">
                                                            <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title="" data-caption="" data-image="image/award/aw-3.jpg" data-target="#image-gallery">
                                                                <img class="img-fluid" src="image/award/aw-3.jpg">
                                                            </a>
                                                        </div>
                                                        <div class="col-md-12 f-left about-award-2">
                                                            <h3>Plaque of Appreciation</h3>
                                                            <p>1 Million Men-hours Without OSHA Record-able Cases</p>
                                                            <h4><b>Client </b>: FLUOR / DOW</h4>
                                                            <h5><b>Project</b> : DOW RO Water Phase-II Project</h5>
                                                            <p><b>Date </b>:07-01-2018</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 f-left">
                                                    <div class="col-md-12 f-left about-award padd0">
                                                        <div class="col-lg-12 thumb onlyaw-img padd0 f-left">
                                                            <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title="" data-caption="" data-image="image/award/aw-3-0.jpg" data-target="#image-gallery">
                                                                <img class="img-fluid" src="image/award/aw-3-0.jpg">
                                                            </a>
                                                        </div>
                                                        <div class="col-md-12 f-left about-award-2">
                                                            <h3>Appreciation Certificate</h3>
                                                            <p>Excellent Support In Torquing & Tenssioning</p>
                                                            <h4><b>Client </b>: SATORP</h4>
                                                            <h5><b>Project</b> : Turn Around 2018</h5>
                                                            <p><b>Date </b>: 04-03-2018</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 f-left">
                                                    <div class="col-md-12 f-left about-award padd0">
                                                        <div class="col-lg-12 thumb onlyaw-img padd0 f-left">
                                                            <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title="" data-caption="" data-image="image/award/aw-4.jpg" data-target="#image-gallery">
                                                                <img class="img-fluid" src="image/award/aw-4.jpg">
                                                            </a>
                                                        </div>
                                                        <div class="col-md-12 f-left about-award-2">
                                                            <h3>Appreciation Certificate</h3>
                                                            <p>Recognition of Excellent EHSS Pperformance</p>
                                                            <h4><b>Client </b>: SABIC / Kemya</h4>
                                                            <h5><b>Project</b> : SEP-sSBR Project</h5>
                                                            <p><b>Date </b>:02-07-2018</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 f-left">
                                                    <div class="col-md-12 f-left about-award padd0">
                                                        <div class="col-lg-12 thumb onlyaw-img padd0 f-left">
                                                            <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title="" data-caption="" data-image="image/award/aw-4-0.jpg" data-target="#image-gallery">
                                                                <img class="img-fluid" src="image/award/aw-4-0.jpg">
                                                            </a>
                                                        </div>
                                                        <div class="col-md-12 f-left about-award-2">
                                                            <h3>Green Flag</h3>
                                                            <p>Best EHSS Mega Project Performer</p>
                                                            <h4><b>Client </b>: SABIC / Kemya</h4>
                                                            <h5><b>Project</b> : SEP-sSBR Project</h5>
                                                            <p><b>Date </b>:02-07-2018</p>
                                                        </div>
                                        ...
                                        <div class="carousel-item">
                                            <div class="col-md-12 ">
                                                <div class="col-md-3 f-left">
                                                    <div class="col-md-12 f-left about-award padd0">
                                                        <div class="col-lg-12 thumb onlyaw-img padd0 f-left">
                                                            <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title="" data-caption="" data-image="image/award/aw-5.jpg" data-target="#image-gallery">
                                                                <img class="img-fluid" src="image/award/aw-5.jpg">
                                                            </a>
                                                        </div>
                                                        <div class="col-md-12 f-left about-award-2">
                                                            <h3>Plaques of Appreciation</h3>
                                                            <p>Safest Sub Contractor Award</p>
                                                            <h4><b>Client </b>: Larsen & Toubro</h4>
                                                            <h5><b>Project</b> : Farabi Normal Paraffin & Derivatives Complex Project</h5>
                                                            <p><b>Date </b>:01-10-2018</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 f-left">
                                                    <div class="col-md-12 f-left about-award padd0">
                                                        <div class="col-lg-12 thumb onlyaw-img padd0 f-left">
                                                            <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title="" data-caption="" data-image="image/award/aw-6.jpg" data-target="#image-gallery">
                                                                <img class="img-fluid" src="image/award/aw-6.jpg">
                                                            </a>
                                                        </div>
                                                        <div class="col-md-12 f-left about-award-2">
                                                            <h3>Green Flag</h3>
                                                ...
                                                <div class="col-md-3 f-left">
                                                    <div class="col-md-12 f-left about-award padd0">
                                                        <div class="col-lg-12 thumb onlyaw-img padd0 f-left">
                                                            <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title="" data-caption="" data-image="image/award/aw-7.jpg" data-target="#image-gallery">
                                                                <img class="img-fluid" src="image/award/aw-7.jpg">
                                                            </a>
                                                        </div>
                                                        <div class="col-md-12 f-left about-award-2">
                                                            <h3>Certificate of Appreciation</h3>
                                                            <p>3 Million Safe Man-hours</p>
                                                            <h4><b>Client </b>: Saudi Aramco / KJO / JGC</h4>
                                                            <h5><b>Project</b> : Global Gas & NGL Recovery & Handling Project</h5>
                                                            <p><b>Date </b>:20-11-2018</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 f-left">
                                                    <div class="col-md-12 f-left about-award padd0">
                                                        <div class="col-lg-12 thumb onlyaw-img padd0 f-left">
                                                            <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title="" data-caption="" data-image="image/award/aw-2.jpg" data-target="#image-gallery">
                                                                <img class="img-fluid" src="image/award/aw-2.jpg">
                                                            </a>
                                                        </div>
                                                        <div class="col-md-12 f-left about-award-2">
                                                            <h3>Plaque of Appreciation</h3>
                                    ...
                                    <a style="margin-left: -34px; opacity: 1" class="carousel-control-prev" href="#Awards18" role="button" data-slide="prev">
                                        <div class="cus-pre">
                                            <img width="10" src="image/left.png">
                                        </div>
                                    </a>
                                    <a style=" margin-right: -34px; opacity: 1" class="carousel-control-next" href="#Awards18" role="button" data-slide="next">
                                        <div class="cus-pre">
                                            <img width="10" src="image/right.png">
                                        </div>
                                    </a>
                        ...
                        <div class="tab-pane fade" id="nav-india" role="tabpanel" aria-labelledby="nav-contact-tab">
                            <div class="col-md-12 padd0">
