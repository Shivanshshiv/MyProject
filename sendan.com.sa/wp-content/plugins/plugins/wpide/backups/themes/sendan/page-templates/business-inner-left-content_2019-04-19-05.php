        			...
        			while ( have_posts() ) :
                        ...
                        <div class="row">
                            <div class="col-md-12 other-service-link">
                                    ...
                                    <div class="row">
                                    <div class="col-12">
                                        <?php if( !emtpy( get_field( 'service_title' ) ) ){  ?> 
                                    	...
                                    	<div class="col-md-12 other-service-link">
                                    		<div style="border-top:1px #ccc solid;margin-top:10px;padding-top:10px;">
                                    			...
                                    			<div class="row">
                                    				...
                                    				<div class="col-4">
                                    					<ul>
                                    						<li>Supported Self Supported Cone Roof</li>
                                    					</ul>
                                    				</div>
                                    			</div>
                                    		</div>
