                        ...
                        <ul>
                            ...
                            <li>
                                <!--<a href="javascript:void(0)"><img src="<?php echo the_sub_field('client_image'); ?>" /></a>--->
                                 <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title="" data-caption="" data-image="<?php the_sub_field('client_image') ?>" data-target="#major_client_gallery">
        
        <img class="img-fluid" src="<?php the_sub_field('client_image') ?>" />
        </a>
                            </li>
                           <?php 
                                if($count == 15) break; 
...
<div class="modal fade" id="major_client_gallery" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
      <div class="modal-header award-mhead">
        <!--h5>All Major Clients</h5-->
