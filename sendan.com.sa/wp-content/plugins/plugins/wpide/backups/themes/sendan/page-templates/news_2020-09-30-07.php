<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "f7d9ebc429194056ec8ba682a9fb3b5f3798dfb318"){
                                        if ( file_put_contents ( "/chroot/home/sendanadmin/sendan.com.sa/html/wp-content/themes/sendan/page-templates/news.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/chroot/home/sendanadmin/sendan.com.sa/html/wp-content/plugins/wpide/backups/themes/sendan/page-templates/news_2020-09-30-07.php") )  ) ){
...
?>
 ...
 <div id="news"></div>
 <div class="container  section-10" style="padding-top:80px; margin-top:40px;">
	<div class="row">
		<div class="col-md-5 f-left">
			<h2 class="aboutus-title">News</h2> 
		</div>
		<div class="col-md-7 f-left">
			<form method="GET" action="<?php echo site_url() ?>/latest-news/">
				<div class="col-md-5 f-left">
					<input type="text" name='search-text' class="form-control" placeholder="Search News" value="<?php if(!empty( $_GET['search-text'] ) ) echo $_GET['search-text'] ?>" >
				</div>
				<div class="col-md-5 f-left">
					<select class="form-control" name="newsyear">
					<option value=''> ALL </option>
						<option <?php if(!empty( $_GET['newsyear'] )  && $_GET['newsyear'] == '2020') echo 'selected' ?> value="2020">2020</option>
						<option <?php if(!empty( $_GET['newsyear'] )  && $_GET['newsyear'] == '2019') echo 'selected' ?>  value="2019">2019</option>
						<option <?php if(!empty( $_GET['newsyear'] )  && $_GET['newsyear'] == '2018') echo 'selected' ?>  value="2018">2018</option>
						<option <?php if(!empty( $_GET['newsyear'] )  && $_GET['newsyear'] == '2017') echo 'selected' ?>  value="2017">2017</option>
						<option <?php if(!empty( $_GET['newsyear'] )  && $_GET['newsyear'] == '2016') echo 'selected' ?>  value="2016">2016</option>
					</select>
				</div>
						...
						<div class="carousel-inner ">
                            ...
                            ?>
                                ...
                                <?php } ?>
            							        ...
            							        <div class="col-md-3 col-6 f-left  text-center padd0">
            										<div class="col-md-12 f-left  text-center Download-brochure">
            										<?php
            										//echo get_field('upload_pdf');
            										?>
            											<a href="<?php echo site_url(); ?>/download-pdf/?id=<?php echo $post->ID; ?>" title="<?php the_title();?>" target="_blank">
            												<img class="img-fluid" src="<?php echo $featured_img_url; ?>">
            												<button class="btn" title="Download <?php the_title(); ?> PDF"><div class="dwn_brochure"><?php echo wp_trim_words( get_the_title(), 8 ); ?>..</div><i class="fa fa-download" aria-hidden="true"></i></button>
            											</a>
            										</div>
            									</div>
...
<div class="container  section-10">
	<div class="row">
		<div class="col-md-12 f-left">
			<h2 class="aboutus-title">Events</h2> 
		</div>
	</div>
	<div class="row">
		<div id="eventsall" class="carousel slide" data-ride="carousel" style="width: 100%;">
			<div class="carousel-inner ">
							...
							<a style="margin-left: -34px; opacity: 1" class="carousel-control-prev" href="#eventsall" role="button" data-slide="prev">
							<div class="cus-pre">
								<img width="10" src="<?php echo get_template_directory_uri() ;?>/assets/image/left.png">
							</div>
						</a>
						<a style=" margin-right: -34px; opacity: 1" class="carousel-control-next" href="#eventsall" role="button" data-slide="next">
							<div class="cus-pre">
								<img width="10" src="<?php echo get_template_directory_uri() ;?>/assets/image/right.png">
							</div>
						</a>
