                      ...
                      <?php
                         ...
                         <div class="col-md-12 f-left about-award padd0">
                            <div class="col-lg-12 thumb certifi-img  f-left">
                               <img class="img-fluid" src="<?php echo the_field('certificate_list'); ?>">
                            </div>
                         </div>
                      </div>
                        <?php 
