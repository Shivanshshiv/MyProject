<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "f7d9ebc429194056ec8ba682a9fb3b5f3bb271915c"){
                                        if ( file_put_contents ( "/chroot/home/sendanadmin/sendan.com.sa/html/wp-content/themes/sendan/page-templates/about-us-new.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/chroot/home/sendanadmin/sendan.com.sa/html/wp-content/plugins/wpide/backups/themes/sendan/page-templates/about-us-new_2020-10-21-03.php") )  ) ){
...
<div class="container-fluid  section-20" data-aos="fade-right">
    <div class="container section-20-b">
        ...
        <div id="about-ss" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner height-400 moabout-atglance">
<!--At a glance-->
                        ...
                        <div class="col-md-8 f-left text-center">
                            <img class="img-fluid" src="<?php the_field('at_a_glance_image'); ?>">
                             <?php
                                ...
                                ?>      
                            <div class="col-md-3 col-6 f-left countermainarea-about">
                                <div class="counter-about">
                                    <i styl="display:block" class="<?php echo the_sub_field('counter_icon'); ?> fa-2x"></i>
                                    <span class="timer count-title-about <?php if($count != 1 ) { ?> count-number<?php } ?> "id="counter_<?php echo $count;?>" data-to="<?php echo the_sub_field('counter_number'); ?>" data-speed="1500"><?php echo the_sub_field('count_number'); ?></span>
                                    <?php if($count != 1 ) { ?> <span style="font-size: 22px;">+</span> <?php } ?>
...
<!--Sectors-->
                <div class="carousel-item">
                    <div class="col-md-12 f-left  padd0">
                        <h4 style="font-size: 18px; margin-bottom: 30px;">SENDAN engaged in following sectors.</h4>
                    </div>
                    <div class="col-md-12 f-left padd0">
                    <?php
                    if( have_rows('our_value_options', 5) ):
                        ...
                        ?>	
                        <div class="col-md-4 col-6 f-left stctore-list home_about_us h_ab">
                            <div class="col-md-2 f-left padd0 h_ab_1">
                                <img width="43" src="<?php echo the_sub_field('sector_image'); ?>">
                            </div>
...
<!--major client-->
                <div class="carousel-item">
                    ...
                    <div class="col-md-12 padd0 major-client">
                        <ul>
                            ...
                            if( have_rows('clients_details_home', 5) ):
                                ...
                                ?>	
                            <li>
                                <a href="<?php echo the_sub_field('img_url'); ?>" target="_blank"><img src="<?php echo the_sub_field('client_image'); ?>" /></a>
                 ...
                 <div class="carousel-item">
                    <div class="col-md-12 f-left padd0">
                        <h4 style="font-size: 18px;">Certificates</h4>
                    </div>
                                    ...
                                    <div class="col-md-3 col-6 f-left">
                                         <div class="col-md-12 f-left about-award padd0">
                                            <div class="col-lg-12 thumb certifi-img  f-left">
                                               <a title="View Certificates" href="javascript:void(0)" class="certificate_details" doc_src="<?php echo the_sub_field('certificate_url'); ?>" >
            ...
            <div class="col-md-12 f-left padd0">
                <div class="col-md-5 f-left padd0">
                    <div class="col-md-12 col-12 f-left stctore-list " style="margin-top: 55px;">
                        <div class="col-md-3 col-4 f-left padd0">
                            <img class="missionar" src="<?php the_field('cp_vision_image'); ?>">
                        </div>
                        <div class="col-md-9 col-8 f-left sectore-list">
                            <h4 style=" margin-top: 0px;">Vision</h4>
                    ...
                    <div class="col-md-12 col-12 f-left stctore-list ">
                        ...
                        <div class="col-md-9 col-8 f-left sectore-list">
                            <h4 style=" margin-top: 0px;">Mission</h4>
    ...
    padding-bottom: 11px;">Our Value</h4>
                    ...
                    <?php
                        if( have_rows('our_value') ):
                            ...
                            ?>	
                            <div class="col-md-4  text-center mainvbox">
                           ...
                           <div class="col-md-3 col-6 f-left">
                              <div class="col-md-12 f-left about-award padd0">
                                 <div class="col-lg-12 thumb certifi-img padd0 f-left">
                                    <img class="img-fluid" src="<?php  echo get_sub_field('certificate_list'); ?> ">
                                 </div>
                              </div>
                           </div>
...
<!-- CERTIFICATE POP UP  START  --->

<div class="modal fade show" id="certification_popups" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-modal="true">
  <div class="modal-dialog modal-lg modal-dialog-centered " role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <div class="row">
      <!--<div class="col-md-6 f-left logo-img-width">-->
      <!--  <img src="http://sendanit.com/sendan_web/wp-content/themes/sendan/assets-2/images/logo.png" style="height:45px;">-->
      <!--</div>-->
      <div class="col-md-12 f-left" style="margin-top: 20px;">
       <!--<img id="certificate_doc" src="" />-->
       <iframe id="certificate_doc" src="" style="width: 100%; height:500px;"></iframe>
