<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "0bdae52e11cf3cce78c578ddf3df4d1c83342fdbe4"){
                                        if ( file_put_contents ( "/home/bestsz6r/public_html/sendanit.com/sendan_web/wp-content/themes/sendan/page-templates/major-projects.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/bestsz6r/public_html/sendanit.com/sendan_web/wp-content/plugins/wpide/backups/themes/sendan/page-templates/major-projects_2020-06-08-13.php") )  ) ){
...
<div class="container  section-10" style="margin-top:80px;">
	<div class="row">
		<div class="col-md-3 f-left">
			<h2 class="aboutus-title">Major Projects</h2> 
		</div>
		<div class="col-md-9 f-left padd0 filter-mobile">
			<form method="GET" action="<?php echo site_url() ?>/major-projects/">
