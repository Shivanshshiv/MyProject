                            ...
                            ?>
                                ...
                                <?php } ?>
            							        ...
            							        <div class="col-md-3 col-6 f-left  text-center padd0">
            										...
            										?>
            											<a href="<?php echo site_url(); ?>/download-pdf/?id=<?php echo $post->ID; ?>" target="_blank">
            												<img class="img-fluid" src="<?php echo $featured_img_url; ?>">
            												<button class="btn" title="Download <?php the_title(); ?>"><div class="dwn_brochure"><?php echo wp_trim_words( get_the_title(), 10 ); ?>..</div><i class="fa fa-download" aria-hidden="true"></i></button>
            											</a>
            										</div>
            									</div>
