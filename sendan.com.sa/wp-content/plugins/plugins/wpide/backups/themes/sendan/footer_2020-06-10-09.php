<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "0bdae52e11cf3cce78c578ddf3df4d1cd60b7d7987"){
                                        if ( file_put_contents ( "/home/bestsz6r/public_html/sendanit.com/sendan_web/wp-content/themes/sendan/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/bestsz6r/public_html/sendanit.com/sendan_web/wp-content/plugins/wpide/backups/themes/sendan/footer_2020-06-10-09.php") )  ) ){
...
document.addEventListener( 'wpcf7mailsent', function( event ) {
 ...
 jQuery(document).ready(function(){
	...
	jQuery(document).on("ajaxComplete", function(){
		...
		jQuery('.wpcf7-mail-sent-ok').hide(20000);
...
<script>
jQuery(document).ready(function(){
var stripString** = $('#counter_1').text().replace(/,/g, '');
$('#counter_1').text(stripString);
});
</script>
