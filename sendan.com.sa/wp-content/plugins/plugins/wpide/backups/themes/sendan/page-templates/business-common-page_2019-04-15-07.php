                                    ...
                                    <div class="col-12">
                                       ...
                                       if( have_rows('services_list') ):     
                                        while ( have_rows('services_list') ) : the_row(); 
                                            ?>    
                                          <li> <a href="<?php echo the_sub_field('service_url') ; ?>" > <?php echo the_sub_field('service_name'); ?></a>  </li>
                                          <?php endwhile;
                                          endif;
                                          ?>
                                          </ul>
