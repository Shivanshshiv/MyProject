				...
				<tbody>
                        ...
                        $args['tax_query'] = array(
                         'relation' => 'AND',
                          array(
                    			...
                    			'field'    => 'slug',
                    			'terms'    => array(( !empty( $_GET['term_slug'] )  ? $_GET['term_slug']  : '' )),
                    		) );         
                    }
                    ...
                    $args['tax_query'] = array(
                      ...
                      array(
                			'taxonomy' => 'pyear',
                			'field'    => 'slug',
                			'terms'    => array( !empty( $_GET['p_year'] )  ? $_GET['p_year']  : '' ),
                		) );         
                    } 
