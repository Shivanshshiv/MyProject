...
<div class="container  section-10" id="your_growth111" data-aos="fade-left">
    <div class="row">
        <div class="col-md-12">
            <h2 class="aboutus-title">Growth At SENDAN</h2>
        </div>
    </div>
    <div class="row"> 
            ...
            <div id="career-20" class="carousel slide" data-ride="carousel">
                ...
                <?php
                    ...
                    if( have_rows('gas_slider_image') ): 
                    	...
                    	?>
                            <li data-target="#career-20" data-slide-to="<?php echo $count; ?>" class="<?php if($count == 0) echo 'active' ?>"></li> 
                            	<?php 
                            $count++;
                        endwhile;
            		 endif;
