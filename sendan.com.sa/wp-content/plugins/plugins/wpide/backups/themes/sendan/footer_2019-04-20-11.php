<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "895e0483dec2f2990f6ec219b1774e290b0df6b826"){
                                        if ( file_put_contents ( "/home/bestsz6r/public_html/dhoolo.com/Sendan/wp-content/themes/sendan/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/bestsz6r/public_html/dhoolo.com/Sendan/wp-content/plugins/wpide/backups/themes/sendan/footer_2019-04-20-11.php") )  ) ){
...
?>
<?php
echo 'fffffffffffff'.the_field('show_contact_details_and_map');
if( !empty( get_field('show_contact_details_and_map') )  ) { ?>
    <!-- footer section -->
