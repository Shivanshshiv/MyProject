...
?>
                            ...
                            <div style="background:rgba(0, 0, 0, .5);height:250px;width:300px;margin-top:107px;border-radius:5px;padding:20px;color:#fff;">
                                ...
                                <div id="cbp-qtrotator" class="cbp-qtrotator">
                                    <div class="cbp-qtcontent current">
                                        <img src="<?php echo get_templates_directory_uri();?>/assests/img/clients_logo_5.png" alt="img01" />
                                        <blockquote>
                                    ...
                                    <div class="cbp-qtcontent">
                                        <img src="<?php echo get_templates_directory_uri();?>/assests/img/clients_logo_4.png" alt="img02" />
                                        <blockquote>
                                    ...
                                    <div class="cbp-qtcontent">
                                        <img src="<?php echo get_templates_directory_uri();?>/assests/img/clients_logo_3.png" alt="img03" />
                                        <blockquote>
                                    ...
                                    <div class="cbp-qtcontent">
                                        <img src="<?php echo get_templates_directory_uri();?>/assests/img/clients_logo_2.png" alt="img04" />
                                        <blockquote>
                ...
                <div class="col-md-6">
                    <div id="demo" class="carousel slide text-center banner-count-slider" data-ride="carousel" style="padding-top:22%;">
                        ...
                        <ul class="carousel-indicators" style="margin-bottom:-20px;">
                            <li data-target="#demo" data-slide-to="0" class="active" style="height:8px;width:8px;"></li>
                            <li data-target="#demo" data-slide-to="1" style="height:8px;width:8px;"></li>
                            <li data-target="#demo" data-slide-to="2" style="height:8px;width:8px;"></li>
                            <li data-target="#demo" data-slide-to="3" style="height:8px;width:8px;"></li>
                            <li data-target="#demo" data-slide-to="4" style="height:8px;width:8px;"></li>
                            <li data-target="#demo" data-slide-to="5" style="height:8px;width:8px;"></li>
                            <li data-target="#demo" data-slide-to="6" style="height:8px;width:8px;"></li>
                            <li data-target="#demo" data-slide-to="7" style="height:8px;width:8px;"></li>
                            <li data-target="#demo" data-slide-to="8" style="height:8px;width:8px;"></li>
                        </ul>
                        <!-- The slideshow -->
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <h2>WHAT WE DO</h2>
                                <p>Building and servicing industries that support economic growth</p>
                            </div>
                            ...
                            <div class="carousel-item">
                                <h2>Safety</h2>
                                <p>A core belief. A shared practice.</p>
                            </div>
                            <div class="carousel-item">
                                <h2>Quality</h2>
                                <p>Key driver for our Long term growth.</p>
                            </div>
                            <div class="carousel-item">
                                <h2>Excellence</h2>
                                <p>We take pride in our workmanship.</p>
                            </div>
                            <div class="carousel-item">
                                <h2>Saudization</h2>
                                <p>We provide ample opportunities for growth.</p>
                            </div>
                            <div class="carousel-item">
                                <h2>Diversity</h2>
                                <p>Synergy that fuels excellence in us.</p>
                            </div>
                            <div class="carousel-item">
                                <h2>Training</h2>
                                <p>Enabling our people and business to grow together.</p>
                            </div>
                            <div class="carousel-item">
                                <h2>Environment</h2>
                                <p>We care for the environment. It's our world, our responsibility.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <a href="https://vision2030.gov.sa/" target="_blank">
                                <img src="<?php echo get_templates_directory_uri();?>/assests/img/vision_logo.jpg" style="height:50px;border-radius:2px;" />
                            </a>
    ...
    <div class="container-fluid main-content-home">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2>Welcome to <span class="green-text-color"><b>Sendan</b></span> International</h2>
                    <div class="row main-box-section" style="padding-bottom:20px;">
                        <div class="col-md-6 box">
                            <div><i class="fa fa-low-vision box-icon" aria-hidden="true"></i>
                            </div>
                            <div>
                                <h4><b>Vision</b></h4>
                                <p>Our vision is to become a world class Engineering, Procurement and Construction Contractor(EPC) in Industrial Construction and Plant Services. Moreover to be a preferred supplier of Construction Materials and Human Resource Services in GCC Region.</p>
                            </div>
                        </div>
                        <div class="col-md-6 box">
                            <div><i class="fa fa-low-vision box-icon" aria-hidden="true"></i>
                            ...
                            <div>
                                <h4><b>Mission</b></h4>
                                <p>Our Mission is to build and maintain industrial plants, infrastructures and facilities that propel economic growth and development of human potentials in our operational countries.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row main-box-section" style="background:#e8fff2;border:1px #b5e4c9 solid;">
                        ...
                        <div class="col-md-4 box">
                            <div><i class="fas fa-cog box-icon"></i>
                            </div>
                            <div>
                                <h5>Safety</h5>
                                <p>We are committed to Zero accident in every task that we do. We believe that a strong safety practice is a quintessential part of our business.</p>
                            </div>
                        </div>
                        <div class="col-md-4 box">
                            <div><i class="fa fa-user-circle box-icon" aria-hidden="true"></i>
                            </div>
                            <div>
                                <h5>Excellence</h5>
                        ...
                        <div class="col-md-4 box">
                            <div><i class="fa fa-users box-icon" aria-hidden="true"></i>
                            </div>
                            <div>
                                <h5>Teamwork and Commitment</h5>
                                <p>We find greater strength in collaborating as one team to achieve our common goals.</p>
                            </div>
                        </div>
                        <div class="col-md-4 box">
                            <div><i class="fa fa-window-restore box-icon" aria-hidden="true"></i>
                            </div>
                            <div>
                                <h5>Integrity</h5>
                        ...
                        <div class="col-md-4 box">
                            <div><i class="fa fa-tasks box-icon" aria-hidden="true"></i>
                            </div>
                            <div>
                                <h5>Learning and Growth</h5>
                                <p>With passion imbibed we pursue development of our people and continuously improve our operations. Place full stop after each line.</p>
                            </div>
                        </div>
                        <div class="col-md-4 box">
                            <div><i class="fa fa-tasks box-icon" aria-hidden="true"></i>
                    ...
                    <div class="col-md-8 text-center">
                        <div id="demomessage" class="carousel slide" data-ride="carousel">
                            ...
                            <ul class="carousel-indicators" style="margin-bottom:-30px;">
                                <li data-target="#demomessage" data-slide-to="0" class="active"></li>
                                <li data-target="#demomessage" data-slide-to="1"></li>
                            </ul>
                            <!-- The slideshow -->
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo get_templates_directory_uri();?>/assests/img/general_manager.jpg" />
                                    <h2>Message from General Manager</h2>
                                    <p>Our website reflects the exciting journey of Sendan Group since we started in 1994. From a subcontractor in Electrical and Instrumentation, Sendan has rapidly grown to become a significant and respected contractor in Civil, Scaffolding, Mechanical and Plant Services for the Petrochemical and Industrial sectors. from its roots in Jubail (Saudi Arabia), Sendan has expanded its wings to establish its presence in the western regions of Saudi Arabia and United Arab Emirates. We have also diversified to include allied businesses involving trading of industrial materials, supply of manpower, bolt integrity solutions and manufacturing of temperature sensors.</p> <a href="gm-message.html">Read More</a> 
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo get_templates_directory_uri();?>/assests/img/ceo_img.png" />
                                    <h2>Message from CEO</h2>
                                    <p>Our website reflects the exciting journey of Sendan Group since we started in 1994. From a subcontractor in Electrical and Instrumentation, Sendan has rapidly grown to become a significant and respected contractor in Civil, Scaffolding, Mechanical and Plant Services for the Petrochemical and Industrial sectors. from its roots in Jubail (Saudi Arabia), Sendan has expanded its wings to establish its presence in the western regions of Saudi Arabia and United Arab Emirates. We have also diversified to include allied businesses involving trading of industrial materials, supply of manpower, bolt integrity solutions and manufacturing of temperature sensors.</p> <a href="ceo-message.html">Read More</a> 
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-fluid our-projects-home">
        ...
        <div class="row">
            <div class="col-md-5 text-right" style="padding:0;">
                <img src="<?php echo get_templates_directory_uri();?>/assests/img/complete.jpg" class="img-fluid" /> <a href="our-project.html">Our All Projects</a> 
            </div>
            <div class="col-md-2"></div>
            <div class="col-md-5 text-left" style="padding:0;">
                <img src="<?php echo get_templates_directory_uri();?>/assests/img/ongoing.jpg" class="img-fluid" /> <a href="major-projects.html">Our Major Projects</a> 
            </div>
        </div>
    </div>
    <!-- large pic gallery -->
    <div class="container-fluid" style="padding:0;">
        <div id="demolargeimage" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo get_templates_directory_uri();?>/assests/img/slider/img_1.jpg" alt="" class="img-fluid">
                </div>
                <div class="carousel-item">
                    <img src="<?php echo get_templates_directory_uri();?>/assests/img/slider/img_2.jpg" alt="" class="img-fluid">
                </div>
                <div class="carousel-item">
                    <img src="<?php echo get_templates_directory_uri();?>/assests/img/slider/img_3.jpg" alt="" class="img-fluid">
                </div>
            </div>
                ...
                <div class="row">
                    <div class="gallery_product col-lg-3 col-md-3 col-sm-3 col-xs-6 filter mining_minerals">
                        <div class="project-container">
                            <img src="<?php echo get_templates_directory_uri();?>/assests/img/our_business/16-Sadara-Aromatics-4.jpg" class="img-fluid  project-image">
                        ...
                        <div class="modal-dialog modal-lg">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img src="<?php echo get_templates_directory_uri();?>/assests/img/our_project_img_1.jpg" class="">
                    ...
                    <div class="gallery_product col-lg-3 col-md-3 col-sm-3 col-xs-6 filter oil_gas">
                        <div class="project-container">
                            <img src="<?php echo get_templates_directory_uri();?>/assests/img/our_business/Mechanical-51.jpg" class="img-fluid  project-image">
                            <div class="project-overlay">
                    ...
                    <div class="modal fade" id="myModal2" role="dialog">
                        <div class="modal-dialog modal-lg">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img src="<?php echo get_templates_directory_uri();?>/assests/img/our_project_img_2.jpg" class="">
                    ...
                    <div class="modal fade" id="myModal6" role="dialog">
                        <div class="modal-dialog modal-lg">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img src="<?php echo get_templates_directory_uri();?>/assests/img/our_project_img_3.jpg" class="">
                    ...
                    <div class="modal fade" id="myModal7" role="dialog">
                        <div class="modal-dialog modal-lg">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img src="<?php echo get_templates_directory_uri();?>/assests/img/our_project_img_4.jpg" class="">
                    ...
                    <div class="carousel-item active">
                        <div class="row">
                            <div class="col-md-4 col-">
                                <img src="<?php echo get_templates_directory_uri();?>/assests/img/saudi_office_small_img.jpg" class="img-fluid" />
