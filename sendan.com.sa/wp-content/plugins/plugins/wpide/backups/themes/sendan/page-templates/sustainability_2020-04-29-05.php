<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "fb4a568ad6bc46b2f21a98b0f9569f50ab400ec852"){
...
<div id="<?php echo strtolower(str_replace(' ', '_', get_sub_field('title'))) ?>" class="<?php echo $sclass ; ?>" <?php if($count == 1 ) echo 'style="margin-top:80px;"' ?>>
   <?php 
   if($count % 2 == 0 ){
