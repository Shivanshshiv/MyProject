    ...
    if( have_rows('slider_counter') ):
        ...
        <div class="col-md-3 col-sm-6 countermainarea">
            <div class="counter">
                ...
                <h2 class="timer count-title count-number " data-to="<?php echo the_sub_field('counter_number'); ?>" data-speed="1500"><?php echo the_sub_field('counter_number'); ?></h2>
                <span style="font-size: 30px; margin-right: 10px; float: right;">+</span>
