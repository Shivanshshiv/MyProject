        ...
        <div class="row">
           ...
           $args = array(
            ...
            if(!empty($_GET["newsmonth"])){
            	...
            	echo $monthName = date("F", mktime(0, 0, 0, $_GET['newsmonth'], 10));
            } 
                                ...
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="col-md-12 pt-3">
                                        <div class="form-group">
                                            <select required class="form-control"name="newsyear" >
                                    ...
                                    <div class="col-md-12 pt-3">
                                        <div class="form-group">
                                            <select  name="newsmonth"  class="form-control"  >
