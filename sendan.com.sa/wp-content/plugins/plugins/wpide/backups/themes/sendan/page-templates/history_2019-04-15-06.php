...
<div class="container-fluid all-pages-padding text-center" style="padding-top:0;">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h2 style="color: #005825; font-weight: bold;   padding-bottom: 40px;">Sendan Journey</h2>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
