<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "fb4a568ad6bc46b2f21a98b0f9569f501dfef27095"){
                                        if ( file_put_contents ( "/home/bestsz6r/public_html/sendanit.com/sendan_web/wp-content/themes/sendan/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/bestsz6r/public_html/sendanit.com/sendan_web/wp-content/plugins/wpide/backups/themes/sendan/footer_2020-04-25-05.php") )  ) ){
        ...
        <div class="container">
            ...
            <div class="col-md-12 padd0 f-left">
                ...
                if( have_rows('branches_&_subsidiaries',  'option') ):
                    ...
                    ?>
                    <div class="<?php  the_sub_field('class_name',  'option'); ?>">
...
Mahape, Navi Mumbai  400710, India.">
                ...
                <div class="col-md-3 head-bbaddress padd0 f-left">
                    <div class="<?php  the_sub_field('class_name',  'option'); ?>">
                        <a href="#" data-tooltip="<?php  the_sub_field('branches_address',  'option'); ?>">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/image/map-20.png">
                        </a>
                    </div>
