<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "7cd6db64469e75e539675678c35544ef6caf223af5"){
                                        if ( file_put_contents ( "/chroot/home/sendanadmin/sendan.com.sa/html/wp-content/themes/sendan/template-parts/header/menu-section.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/chroot/home/sendanadmin/sendan.com.sa/html/wp-content/plugins/wpide/backups/themes/sendan/template-parts/header/menu-section_2020-09-18-12.php") )  ) ){
 ...
 ?>
    ...
    <nav id="navbar" class="navbar navbar-expand-lg navbar-dark main-menu">
        ...
        <a href="<?php echo home_url();?>" class="navbar-brand"><?php the_custom_logo(); ?></a>
