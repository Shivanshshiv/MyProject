<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "895e0483dec2f2990f6ec219b1774e29e3d7ed36a9"){
                                        if ( file_put_contents ( "/home/bestsz6r/public_html/dhoolo.com/Sendan/wp-content/themes/sendan/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/bestsz6r/public_html/dhoolo.com/Sendan/wp-content/plugins/wpide/backups/themes/sendan/header_2019-04-12-13.php") )  ) ){
	 ...
	 <div class="container">
	   <div class="row">
	    <div class="col-md-12"><br><br>
		 <h2>Message from  <span class="green-text-color"><b>CEO</b></span> </h2>
		 <p class="main-p">Welcome to the Sendan website!</p>
