		...
		<div class="col-md-9 f-left padd0 filter-mobile">
			<form method="GET" action="<?php echo site_url() ?>/our-project/">
				...
				<div class="col-md-2 f-left">
					<button type="submit" class="btn  btn-primary-2 mb-2">Search Project</button>
				</div>
			</form>
		</div>
	</div>
