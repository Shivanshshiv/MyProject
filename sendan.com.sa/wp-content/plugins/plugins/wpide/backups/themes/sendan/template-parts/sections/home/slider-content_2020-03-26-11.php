        ...
        <div class="client-review-w">
         <?php 
             ...
             ?>
                ...
                <div id="cbp-qtrotator" class="cbp-qtrotator  <?php echo ( $count == 1 ) ? '  current' : '' ; ?> ">  ">
                    <?php 
                        $args = array(
                        ...
                        <div class="cbp-qtcontent maincctext" style="display: none;">
                        <?php
