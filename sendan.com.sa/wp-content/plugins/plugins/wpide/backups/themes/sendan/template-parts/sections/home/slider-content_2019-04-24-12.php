            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php 
                     ...
                     ?>
                        <h4 style="border-bottom:1px #ccc solid;"><?php echo $client_review_details['title'] ; ?></h4>
        ...
        ?>
         ...
         ?>       
            ...
            <div style="background:rgba(0, 0, 0, .5);height:250px;width:300px;margin-top:20px;border-radius:5px;float:right;padding:20px;color:#fff;">
                <h4 style="border-bottom:1px #ccc solid;"><?php echo $news_details['news_title'] ; ?></h4>  
                <div class="newstape">
