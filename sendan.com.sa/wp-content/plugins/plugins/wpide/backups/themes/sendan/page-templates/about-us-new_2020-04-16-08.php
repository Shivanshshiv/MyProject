                    ...
                    <div id="cmhistory" class="carousel slide">
                        ...
                        <?php
                                if( have_rows('history_details') ):
                                    ...
                                    echo $no_of_history;
                                    $no_loop = $no_of_history % $onetime_show ;
                                    echo $no_loop;
                                    while ( have_rows('history_details') ) : the_row(); $count++;
