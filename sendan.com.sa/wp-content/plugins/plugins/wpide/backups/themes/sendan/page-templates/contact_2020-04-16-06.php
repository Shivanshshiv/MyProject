            ...
            <?php
                if( have_rows('global_presence') ):
                    ...
                    while ( have_rows('global_presence') ) : the_row(); $count++;
                        ...
                        $make_slug = str_replace(' ', '-', strtolower($country_title)); 
                    ?>	
            <div class="tab-pane fade show <?php if($count == 1) echo 'active' ; ?>" id="nav-<?php echo $make_slug; ?>" role="tabpanel" aria-labelledby="nav-<?php echo $make_slug; ?>-tab">
                <div class="col-md-12 padd0">
