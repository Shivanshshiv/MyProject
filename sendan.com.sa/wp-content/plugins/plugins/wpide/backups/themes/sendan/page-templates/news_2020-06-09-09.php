            							        ...
            							        <div class="col-md-3 col-6 f-left  text-center padd0">
            										...
            										?>
            											<a href="<?php echo site_url(); ?>/download-pdf/?id=<?php echo $post->ID; ?>" title="<?php the_title();?>" target="_blank">
            												...
            												<button class="btn" title="Download <?php the_title(); ?>"><div class="dwn_brochure"><?php echo wp_trim_words( get_the_title(), 8 ); ?>..</div><i class="fa fa-download" aria-hidden="true"></i></button>
            											</a>
            										</div>
            									</div>
