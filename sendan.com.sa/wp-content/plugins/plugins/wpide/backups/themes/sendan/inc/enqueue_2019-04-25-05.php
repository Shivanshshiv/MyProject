<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "895e0483dec2f2990f6ec219b1774e296f4964da7d"){
                                        if ( file_put_contents ( "/home/bestsz6r/public_html/dhoolo.com/Sendan/wp-content/themes/sendan/inc/enqueue.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/bestsz6r/public_html/dhoolo.com/Sendan/wp-content/plugins/wpide/backups/themes/sendan/inc/enqueue_2019-04-25-05.php") )  ) ){
...
class Sendan_Scripts
{
    ...
    public function enqueue_styles()
    {
        ...
        wp_enqueue_style('slider', SENDAN_CSS_URI . 'slider.css', array() , '2.3.4');
           wp_enqueue_style('slider', 'https://use.fontawesome.com/releases/v5.6.3/css/all.css', array() , '2.3.4');
