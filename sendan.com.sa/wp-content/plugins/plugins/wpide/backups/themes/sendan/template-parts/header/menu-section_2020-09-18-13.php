<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "7cd6db64469e75e539675678c35544ef33e2c2be18"){
                                        if ( file_put_contents ( "/chroot/home/sendanadmin/sendan.com.sa/html/wp-content/themes/sendan/template-parts/header/menu-section.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/chroot/home/sendanadmin/sendan.com.sa/html/wp-content/plugins/wpide/backups/themes/sendan/template-parts/header/menu-section_2020-09-18-13.php") )  ) ){
        ...
        <div class="navbar-collapse collapse order-md-last" id="mainNav">
            <ul class="navbar-nav ml-auto">
                ...
                if( have_rows('menu_details' ,'option') ):
                    ...
                    ?>
                        <li class="nav-item dropdown drop-down-mega menu__after">
