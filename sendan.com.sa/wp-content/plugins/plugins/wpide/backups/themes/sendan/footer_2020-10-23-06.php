<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "f7d9ebc429194056ec8ba682a9fb3b5ffc48971353"){
                                        if ( file_put_contents ( "/chroot/home/sendanadmin/sendan.com.sa/html/wp-content/themes/sendan/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/chroot/home/sendanadmin/sendan.com.sa/html/wp-content/plugins/wpide/backups/themes/sendan/footer_2020-10-23-06.php") )  ) ){
    ...
    setTimeout(function () {
      ...
      jQuery(".certificate_details").click(function(){
        //var value = jQuery(this).attr('data-filter');
          ...
          console.log(docsrc);
          jQuery("#certificate_doc").attr('src',docsrc)
