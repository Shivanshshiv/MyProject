...
<!--Sectors-->
                <div class="carousel-item">
                    ...
                    if( have_rows('our_value_options', 5) ):
                        ...
                        ?>	
                        <div class="col-md-4 col-6 f-left stctore-list home_about_us">
                            <div class="col-md-2 f-left padd0">
                                <img width="43" src="<?php echo the_sub_field('sector_image'); ?>">
                            </div>
                            <div class="col-md-10 f-left sectore-list">
...
<div class="container-fluid  section-20">
    ...
    padding-bottom: 11px;">Our Values</h4>
                    <div class="row">
                    <?php
