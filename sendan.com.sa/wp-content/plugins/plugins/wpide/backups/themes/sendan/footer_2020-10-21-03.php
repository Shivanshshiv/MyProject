<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "f7d9ebc429194056ec8ba682a9fb3b5f3bb271915c"){
                                        if ( file_put_contents ( "/chroot/home/sendanadmin/sendan.com.sa/html/wp-content/themes/sendan/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/chroot/home/sendanadmin/sendan.com.sa/html/wp-content/plugins/wpide/backups/themes/sendan/footer_2020-10-21-03.php") )  ) ){
...
<?php                   
             ...
             <div class="col-md-12 mainhh-branch padd0 f-left">
                ...
                <h4>Affiliates and group companies</h4>
            </div>
 ...
 <?php 
                if( have_rows('branch_address',  'option') ):
                    ...
                    ?>
                  <div class="col-md-2 all-bbaddress padd0 f-left bbaddess" style="margin-right: 35px;">
	   ...
	   <div class="row">
		...
		<div class="col-md-6">
		 <div class="row">
		  ...
		  <div class="col-md-6">
		   <ul>
			  <li><a href="https://sendan.com.sa/our-business/civil-construction/"><i class="fas fa-chevron-right"></i> Civil Construction</a></li>
			  <li><a href="https://sendan.com.sa/our-business/mechanical-construction/"><i class="fas fa-chevron-right"></i> Mechanical Construction</a></li>
			  <li><a href="https://sendan.com.sa/our-business/electrical-instrumentation-construction/"><i class="fas fa-chevron-right"></i> Electrical & Instrumentation Construction</a></li>
			  <li><a href="https://sendan.com.sa/our-business/plant-services/"><i class="fas fa-chevron-right"></i> Plant Services</a></li>
			  <li><a href="https://sendan.com.sa/our-business/scaffolding-services/"><i class="fas fa-chevron-right"></i> Scaffolding Services</a></li>
			  <li><a href="https://sendan.com.sa/our-business/bolt-integrity-solutions/"><i class="fas fa-chevron-right"></i> Bolt Integrity Solutions</a></li>
			 </ul>
		  </div>
		  <div class="col-md-6">
		   <ul>
			  <li><a href="https://sendan.com.sa/our-business/electrical-maintenance-testing-commissioning/"><i class="fas fa-chevron-right"></i>Electrical Maintenance, Testing & Commissioning</a></li>
			  <li><a href="https://sendan.com.sa/our-business/construction-services/"><i class="fas fa-chevron-right"></i> Construction Services</a></li>
			  <li><a href="https://sendan.com.sa/our-business/human-resource-services/"><i class="fas fa-chevron-right"></i> Human Resource Services</a></li>
			  <li><a href="https://sendan.com.sa/our-business/warehousing-material-handling/"><i class="fas fa-chevron-right"></i> Warehousing & Material Handling</a></li>
			  <li><a href="https://sendan.com.sa/our-business/skid-manufacturing/"><i class="fas fa-chevron-right"></i>Skid Manufacturing</a></li>
			 </ul>
		  </div>
		 </div>
		</div>
...
<div class="container-fluid footer-bottom-home">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 text-right mobile-text-foot"> 
      <a target="_blank" href="https://www.facebook.com/Sendaninternational"><i class="fab fa-facebook-f"></i></a>
     <!-- <a target="_blank" href="https://twitter.com/SendanSaudi"><i class="fab fa-twitter"></i></a>-->
      <a target="_blank" href="https://twitter.com/SendanSaudi"><i class="fab fa-twitter"></i></a>
      <a target="_blank" href="https://www.linkedin.com/company/sendan-al-emarat-contracting-llc"><i class="fab fa-linkedin-in"></i></a> 
      <!--<a target="_blank" href="https://www.linkedin.com/company/1133126/admin/"><i class="fab fa-linkedin-in"></i></a> -->
      </div>
    </div>
  </div>
</div>
...
<div class="Request-area">
  <ul>
    <li>
      <a href="<?php echo site_url();?>/contact-us/"><i class="fa fa-clock"></i><b>Request a Meeting</b></a>
    </li>
  </ul>
</div>
...
jQuery('#basicSlider').multislider({
    ...
    jQuery('#mixedSlider_people').multislider({
      duration: 400,
      interval: 1000
    });
...
// jQuery("#numberonly").change(function(){ 
//     var value =jQuery("#numberonly").val().length;
     
    
//     if(parseFloat(value) < 15)
//     {
//             jQuery('#mobilenumberbug').show();
//             jQuery('#mobilenumberbug').hover();
//     }
//     else
//     jQuery('#mobilenumberbug').hide();
...
document.addEventListener( 'wpcf7mailsent', function( event ) {
 ...
 jQuery(document).ready(function(){
	...
	jQuery(document).on("ajaxComplete", function(){
		...
		jQuery('.wpcf7-mail-sent-ok').hide(5000);
		
	});
	
	var tabCarousel = setInterval(function() {
    var tabs = jQuery('#cmhistory .nav-tabs > li'),
...
jQuery(document).ready(function(){
    ...
    /*jQuery("#nationaldayvideomodal").modal('show');
    document.getElementById('save_video_src').play();
    setTimeout(function () {
        jQuery(".closevideo").trigger('click');
      }, 15000);*/

      
      jQuery(".certificate_details").click(function(){
        //var value = jQuery(this).attr('data-filter');
        
        
          var docsrc = jQuery(this).attr('doc_src');
          console.log(docsrc);
          jQuery("#certificate_doc").attr('certificate_doc',docsrc)
          jQuery("#certification_popups").modal('show');
