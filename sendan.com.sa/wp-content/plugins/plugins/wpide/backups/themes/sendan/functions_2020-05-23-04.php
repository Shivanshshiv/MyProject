<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "0bdae52e11cf3cce78c578ddf3df4d1c7d3d40d0cb"){
                                        if ( file_put_contents ( "/home/bestsz6r/public_html/sendanit.com/sendan_web/wp-content/themes/sendan/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/bestsz6r/public_html/sendanit.com/sendan_web/wp-content/plugins/wpide/backups/themes/sendan/functions_2020-05-23-04.php") )  ) ){
...
//   print_r($contact_form);
  ...
  if($posted_data['_wpcf7'] == '2634'){
      if($posted_data['brochure_no'] == 'Brochure 1'){
          echo "war ";
        $mailProp = $contact_form->get_properties('mail');
       // print_r($mailProp);
       
       //echo $mailProp['mail']['recipient'];
       echo $mailProp['mail']['body']['brochure_no'];
       
       $mailProp['body'] = str_replace('[brochure_no]',  '-blah blah', $mailProp['body']);
       
       
       // $mailProp['mail']['body'] = 'ffffffffffffffff';
        // $mail['body'] = str_replace('[brochure_no]', 'sadfasfdsafasfsfdsfsfds', $mail['body']);
