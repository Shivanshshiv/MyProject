	 ...
	 <?php
		...
		<div class="col-md-4 col-6 f-left stctore-list ">
			...
			<div class="col-md-9 f-left sectore-list">
				...
				<p><?php echo the_sub_field('ourvaluedescription'); ?>,</p> <a href="<?php echo the_sub_field('url_of_sector'); ?>">Explore more</a>
			</div>
...
<div class="carousel-item">
	...
	<div class="col-md-12 padd0 major-client">
		<ul>
			...
			<li><a href="javascript:void(0)"><img src="<?php  echo the_sub_field('client_image');   ?>" /></a>
			</li>
			<?php endwhile; endif; ?>
		</ul>
