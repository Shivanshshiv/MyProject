    ...
    if( have_rows('slider_counter') ):
        ...
        <div class="col-md-3 col-sm-6 countermainarea">
            <div class="counter">
                ...
                <span class="timer count-title count-number" id="counter_<?php $count;?>"  data-to="<?php echo the_sub_field('counter_number'); ?>" data-speed="1500"><?php echo the_sub_field('counter_number'); ?></span>
                <?php if( $count != 1 ) { ?><span style="font-size: 30px; margin-right: 0px; float: right;">+</span> <?php } ?>
