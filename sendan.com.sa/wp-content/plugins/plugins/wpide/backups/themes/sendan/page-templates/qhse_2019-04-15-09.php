                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="row" style="padding-top:20px;text-align:center;">
                                <div class="col-md-3">
                                    <!-- Trigger the Modal -->
                                    <img id="myImg" src="<?php echo get_template_directory_uri() ?>/assets/img/ISO-90012015_001-211x300-big-img.jpg" alt="Sendan International Company Ltd." style="width:100%;max-width:300px">
