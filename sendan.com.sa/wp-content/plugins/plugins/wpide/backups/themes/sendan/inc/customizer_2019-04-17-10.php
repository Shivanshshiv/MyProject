...
function sendan_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( 'c_map_address', array( 'label' => esc_html__( 'Enter Contact map Shortcode', 'sendan' ), 'section' => 'contact_us', 'type' => 'textarea', 'settings' => 'contact_map_address', ) );
    
    $wp_customize->add_setting('widget_padding', array('capability' => 'edit_theme_options', 'type' => 'theme_mod', 'default' => '20'));
 
$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'footer', array('label' => 'Widget Padding', 'section' => 'contact_us', 'setting' => 'widget_padding', 'type' => 'select', 'choices' => array('0' => '0px', '10' => '10px', '20' => '20px', '30' => '30px', '40' => '40px', '50' => '50px'))));
