<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "fb4a568ad6bc46b2f21a98b0f9569f50c093b4539c"){
                                        if ( file_put_contents ( "/home/bestsz6r/public_html/sendanit.com/sendan_web/wp-content/themes/sendan/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/bestsz6r/public_html/sendanit.com/sendan_web/wp-content/plugins/wpide/backups/themes/sendan/footer_2020-03-29-08.php") )  ) ){
...
<?php 
if( have_rows('branches_&_subsidiaries') ):

 	// loop through the rows of data
    while ( have_rows('branches_&_subsidiaries') ) : the_row();
    
    ?>
  <div class="col-md-3 all-bbaddress padd0 f-left">
    <p><?php  the_sub_field('branches_name'); ?></p>
    <h4><?php  the_sub_field('branch_address'); ?></h4>
  </div>
