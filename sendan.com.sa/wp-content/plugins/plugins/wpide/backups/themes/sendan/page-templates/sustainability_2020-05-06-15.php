    ...
    <div class="container section-20-b">
        <div class="row">
            ...
            <div class="col-md-12">
                    ...
                    <div id="localization" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner height-200">
                            <div class="carousel-item">
                                <img style="width: 100%;" src="image/all/05.jpg">
                            </div>
                            <div class="carousel-item active">
                                <img style="width: 100%;" src="image/all/06.jpg">
                            </div>
                        </div>
                ...
                <div class="col-md-7 mt-20 f-left aos-init" data-aos="fade-left">
                    <p class="all-p">SENDAN pursues a policy of inclusion and integration for our localization of Saudi employees. We provide them with ample opportunities for intensive training, grooming and professional growth. SENDAN is also among the pioneers to hire Saudi females and gives utmost importance to their development. </p>
                </div>
            </div>
        </div>
