...
//     print_r($posted_data['country']);
//     if($posted_data['country'] == 'Saudi Arabia'){
       
//       // email address you want to change
//         $toEmail = 'hariom.kumar@crebritech.com';
         
//         // set the email address to recipient
//         $mailProp = $submission->get_properties('mail');
//         $mailProp['mail']['recipient'] = $toEmail;
         
//         // update the form properties
//         $submission->set_properties(array('mail' => $mailProp['mail']));
