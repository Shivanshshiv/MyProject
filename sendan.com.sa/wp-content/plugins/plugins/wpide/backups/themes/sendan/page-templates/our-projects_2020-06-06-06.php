    ...
    <div class="modal-content">
      ...
      <div class="col-md-6 padd0 f-left">
       ...
       <div class="col-md-6 padd0 f-left text-right">
        <img src="<?php the_field('project_details_image'); ?>">
      </div>
