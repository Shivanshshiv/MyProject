            ...
            <form method="GET" action="<?php echo site_url() ?>/our-project/">
                <div id="example_filter" class="dataTables_filter">
                    <label>Search:
                        ...
                        <input type="search" name="search-text"  value="<?php if(!empty( $_GET['search-text'] ) ) echo $_GET['search-text'] ?>" class="form-control input-sm" placeholder="" aria-controls="example">
                    </label>
                </div>
            </form>
            </div>
