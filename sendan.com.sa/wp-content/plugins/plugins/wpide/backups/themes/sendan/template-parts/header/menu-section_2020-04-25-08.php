<?php /* start WPide restore code */
                ...
                if( have_rows('menu_details' ,'option') ):
                    ...
                    ?>
                        <li class="nav-item dropdown drop-down-mega">
                            <a class="nav-link ddicon" href="#about2" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <?php  while ( have_rows('menu_section' ,'option') ) : the_row(); ?>
                                        <div class="col-md-3 f-left menulistabb">
                                            <ul> <?php  while ( have_rows('menu_list' ,'option') ) : the_row(); ?>
                                                <li><a href="<?php the_sub_field('page_list'); ?>"><?php the_sub_field('page_name'); ?></a></li>
                                                 <?php endwhile; ?>
                                            </ul>
                                        </div>
                                    <?php endwhile; ?>
 ...
 <?php /* <nav id="navbar" class="<?php echo $nav_class ;?>">
