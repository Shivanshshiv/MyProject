<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "895e0483dec2f2990f6ec219b1774e29891ec0b68f"){
                                        if ( file_put_contents ( "/home/bestsz6r/public_html/dhoolo.com/Sendan/wp-content/themes/sendan/taxonomy-sector-type.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/bestsz6r/public_html/dhoolo.com/Sendan/wp-content/plugins/wpide/backups/themes/sendan/taxonomy-sector-type_2019-04-23-06.php") )  ) ){
            ...
            <div class="col-sm-6">
                <div class="dataTables_length" id="example_length">
                    <label>Select the sector
                        <select name="example_length" aria-controls="example" class="form-control input-sm" id="sector-type" >
                            <option data-url="<?php echo site_url() ;?>/Our Project/'" value="all">All</option>
                            <?php
                                ...
                                $sector_type = get_terms( 'sector-type' , array(  'hide_empty' => false ) );
        							...
        							foreach ( $sector_type as $sector ) {
        							    $select_value = ( $sector->slug == $sector_cat_slug ) ? 'selected = "selected"' : '' ; 
