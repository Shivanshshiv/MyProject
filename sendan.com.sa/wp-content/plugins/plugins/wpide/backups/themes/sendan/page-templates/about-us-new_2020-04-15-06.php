            ...
            <div class="carousel-inner height-400">
                <div class="carousel-item active">
                    <div class="row ">
                        <div class="col-md-8 f-left text-center">
                            <img class="img-fluid" src="image/ban21.jpg">
                            <div class="col-md-3 col-sm-6 f-left countermainarea-about">
                                <div class="counter-about">
                                    <i class="fa fa-building fa-2x"></i>
                                    <h2 class="timer " data-to="1994" data-speed="1500">4200</h2>
                                    <p>FOUNDED</p>
                                </div>
                            </div>
                            <div class="col-md-3 col-xs-6 f-left countermainarea-about">
                                <div class="counter-about"> <i style="display: block;" class="fa fa-file fa-2x"></i>
                                    <span class="timer count-title-about count-number" data-to="400" data-speed="500"></span>
                                    <span style="font-size: 30px;">+</span>
                                    <p class="count-text ">PROJECTS </p>
                                </div>
                            </div>
                            <div class="col-md-3 col-xs-6 f-left countermainarea-about">
                                <div class="counter-about"> <i style="display: block;" class="fa fa-users fa-2x"></i>
                                    <span class="timer count-title-about count-number" data-to="4200" data-speed="400"></span>
                                    <span style="font-size: 30px; padding-left:5px;">+</span>
                                    <p class="count-text ">EMPLOYEE</p>
                                </div>
                            </div>
                            <div class="col-md-3 f-left countermainarea-about">
                                <div class="counter-about"> <i style="display: block;" class="fa fa-globe fa-2x"></i>
                                    <span class="timer count-title-about count-number" data-to="15" data-speed="1500">15</span>
                                    <span style="font-size: 30px; margin-left: 10px; ">+</span>
                                    <p class="count-text ">PRESENCE </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 f-left right-headar">
                            <div class="col-md-12 f-left head-offic-ab mt-0">
                                <h4>Headquarters</h4>
                                <ul>
                                    <li>Jubail Industrial City,Saudi Arabia</li>
                                </ul>
                            </div>
                            <div class="col-md-12 f-left head-offic-ab">
                                <h4>Branch</h4>
                                <ul>
                                    <li>Yanbu, Saudi Arabia</li>
                                    <li>Dubai, United Arab Emirates</li>
                                    <li>Dubai Freezone</li>
                ...
                <div class="carousel-item">
                    ...
                    <div class="col-md-12 f-left padd0">
                        ...
                        <div class="col-md-4 col-6 f-left stctore-list ">
                            <div class="col-md-3 f-left padd0">
                                <img width="60" src="image/refinery.png">
                            </div>
                            <div class="col-md-9 f-left sectore-list">
                        ...
                        <div class="col-md-4 col-6 f-left stctore-list ">
                            <div class="col-md-3 f-left padd0">
                                <img width="60" src="image/thunder.png">
                            </div>
                            <div class="col-md-9 f-left sectore-list">
                                <h4>Water & Electricity</h4>
                                <p>Considered being the biggest sector in the world in terms of dollar value, </p>
                                <a href="#">Read more</a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-6 f-left stctore-list ">
                            <div class="col-md-3 f-left padd0">
                                <img width="60" src="image/truck.png">
                            </div>
                            <div class="col-md-9 f-left sectore-list">
                        ...
                        <div class="col-md-4 col-6 f-left stctore-list ">
                            <div class="col-md-3 f-left padd0">
                                <img width="60" src="image/town.png">
                            </div>
                            <div class="col-md-9 f-left sectore-list">
                    ...
                    <div class="col-md-12 f-left padd0">
                        ...
                        <div class="col-md-12 padd0">
                            <div class="col-md-5 padd0 lefta-sus f-left">
                                <img class="img-fluid" src="image/exper-img.jpg">
                            </div>
                            <div class="col-md-7  righta-expertise f-left ">
                                <div class="col-md-6 padd0  righta-expertise-20 f-left ">
                                    <ul>
                                        ...
                                        <li><a href="#">Electrical & Instrumentation Construction</a></li>
                                        <li><a href="#">Plant Services (Maintenance & Shutdown)</a></li>
                                        <li><a href="#">Scaffolding Services</a></li>
                                        <li><a href="#">Bolt Integrity Solution</a></li>
                                        <li><a href="#">Electrical Maintenance, Testing & Commissioning Services </a></li>
                                ...
                                <div class="col-md-6   righta-expertise-20 f-left p-r-0">
                                    <ul>
                                        <li><a href="#">Human Resource Services </a></li>
                                        <li><a href="#">Warehousing & Material Handling</a></li>
                                        <li><a href="#">Industrial Material Supply </a></li>
                                        <li><a href="#">Technical Services Division</a></li>

                                        <li><a href="#">Skid Manufacturing</a></li>
                                        <li><a href="#">Blast Resistant Modules</a></li>
                                        <li><a href="#">Integrated Turnkey Solution Provider (Telecommunication & Automation System)</a></li>
                                        <li><a href="#">Manufacturing of Temperature Sensors</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="col-md-12 padd0 major-client">
                        <ul>
                            ...
                            <li>
                                <a href="#"><img src="image/logo6.png" /></a>
                            </li>
                            <li>
                                <a href="#"><img src="image/logo7.png" /></a>
                            </li>
                            <li>
                                <a href="#"><img src="image/logo8.png" /></a>
                            </li>
                            <li>
                                <a href="#"><img src="image/logo9.png" /></a>
                            </li>
                            <li>
                                <a href="#"><img src="image/logo10.png" /></a>
                            </li>
                            <li>
                                <a href="#"><img src="image/logo11.png" /></a>
                            </li>
                            <li>
                                <a href="#"><img src="image/logo12.png" /></a>
                            </li>
                            <li>
                                <a href="#"><img src="image/logo13.png" /></a>
                            </li>
                            <li>
                                <a href="#"><img src="image/logo14.png" /></a>
                            </li>
                            <li>
                                <a href="#"><img src="image/logo15.png" /></a>
                            </li>
                        </ul>
