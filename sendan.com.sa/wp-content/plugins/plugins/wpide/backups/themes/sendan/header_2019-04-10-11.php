<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "895e0483dec2f2990f6ec219b1774e29b42cb94a1a"){
                                        if ( file_put_contents ( "/home/bestsz6r/public_html/dhoolo.com/Sendan/wp-content/themes/sendan/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/bestsz6r/public_html/dhoolo.com/Sendan/wp-content/plugins/wpide/backups/themes/sendan/header_2019-04-10-11.php") )  ) ){
...
<body <?php body_class(); ?>>
    <div class="custom">
        <div class="pic-wrapper">
            <figure class="pic-1">
                <img src="<?php echo get_template_directory_uri() ?>/assets/img/slide/1.jpg" alt="slide1" />
            </figure>
            <figure class="pic-2">
                <img src="<?php echo get_template_directory_uri() ?>/assets/img/slide/2.jpg" alt="slide1" />
            </figure>
            <figure class="pic-3">
                <img src="<?php echo get_template_directory_uri() ?>/assets/img/slide/3.jpg" alt="slide1" />
            </figure>
            <figure class="pic-4">
                <img src="<?php echo get_template_directory_uri() ?>/assets/img/slide/4.jpg" alt="slide1" />
            </figure>
        </div>
        <br/>
