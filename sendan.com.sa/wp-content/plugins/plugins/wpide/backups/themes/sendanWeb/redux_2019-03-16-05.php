<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "895e0483dec2f2990f6ec219b1774e2985ad5ea380"){
                                        if ( file_put_contents ( "/home/bestsz6r/public_html/dhoolo.com/Sendan/wp-content/themes/sendanWeb/redux.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/bestsz6r/public_html/dhoolo.com/Sendan/wp-content/plugins/wpide/backups/themes/sendanWeb/redux_2019-03-16-05.php") )  ) ){
...
$blocks_array[$block->ID] = $block->post_title;
    ...
    // 	    'type' => 'text', 
    // 		'title' => __("Review Section Title", 'panoply'),
	...
	//Page Behaviour
Redux::setSection( $opt_name, array(
        'title'            => __( 'Page Behaviour', 'panoply' ),
        'id'               => 'page_behaviour',
        'subsection'       => true,        
        ...
        'fields'           => array(
		  array(
				 ...
				 'type'     => 'switch',
				 'title'    => __('Page Loading Animation', 'panoply'), 
				 'subtitle' => __('Select loading animation on page', 'panoply'),
				 'default' => '1'
			 ),	
 array(
                'id'       => 'loading_animation_color',
                'type'     => 'color',
                'title'    => __( 'Loading Animation Color', 'panoply' ),
                'subtitle' => __( 'Pick a loading animation color(default: #dd9933).', 'panoply' ),
                'default'  => '#dd9933',
                'validate' => '',
				'transparent'=>false,
				'required' => array('loading_animation','=','1')
            ),
			/*array(
 'id'=>'loading_styles',
 'type' => 'select', 
 'customizer' => true,
  'title' => __('Loading styles', 'panoply'),
 'subtitle' => __('Loading styles', 'panoply'),
 'options'  => array(
        '1' => __('Up/Down','panoply' ),
        '2' => __('Fade In','panoply' ),
		'3' => __('Fade Out','panoply' ),
		'4' => __('Left/Right', 'panoply' ),      
    ),
    'default'  => '1',
 ),*/
 array(
     'id'       => 'smooth_scroll',
     'type'     => 'switch',
     'title'    => __('Smooth Scroll', 'panoply'), 
     'subtitle' => __('Enable/Disable smooth scroll on all pages', 'panoply'),
     'default' => '1'
 ),
 array(
     'id'       => 'back_to_top',
     'type'     => 'switch',
     'title'    => __('Back to Top', 'panoply'), 
     'subtitle' => __('Enable/Disable back to top on all pages', 'panoply'),
     'default' => '1'
 ),	
array(
     'id'       => 'preloaded_image',
	...
	'url'=> true,
      'customizer' => true,
     'title'    => __('Preloaded Image', 'panoply'), 
     'subtitle' => __('Upload or enter the direct path to your preloaded image', 'panoply'),
  ),
  array(
     'id'       => 'sticky_menu',
     'type'     => 'switch',
     'title'    => __('Sticky Menu', 'panoply'), 
     'subtitle' => __('Enable/Disable sticky menu on all pages', 'panoply'),
     'default' => '1'
 ),	
 array(
     'id'       => 'breadcrumbs',
     'type'     => 'switch',
     'title'    => __('Breadcrumbs', 'panoply'), 
     'subtitle' => __('Enable/Disable breadcrumbs on all inner pages', 'panoply'),
     'default' => '1'
 ),)
    ) );
...
Redux::setSection( $opt_name, array(
	  ...
	  'id'       => 'css_editor',
	  'type'     => 'ace_editor',
	  'title'    => __('Custom CSS', 'panoply'),
	  'subtitle' => __('Quick and easy-to-use solution to add custom CSS code to your website', 'panoply'),
	  'mode'     => 'css',
	  'theme'    => 'monokai',
	  'desc'     => '',
  ),
  array(
	  'id'       => 'js_editor',
	  'type'     => 'ace_editor',
	  'title'    => __('Custom JS', 'panoply'),
	  'subtitle' => __('Quick and easy-to-use solution to add custom JavaScript code to your website', 'panoply'),
	  'mode'     => 'javascript',
	  'theme'    => 'chrome',
	...
	Redux::setSection( $opt_name, array(
     ...
     'fields' => array(
array(
     'id'       => 'logo_favicon_opt1',
     'type'     => 'radio',
     'title'    => __('Logo Type', 'panoply'), 
     'subtitle' => __('Select whether you want your main logo to be an image or text', 'panoply'),
	  'class'     => 'select_style',
       'options'  => array(
         '1' => __('Image', 'panoply'),
         '2' => __('Text Logo','panoply'), 
      ),
     'default' => '1'
 ),	 
 array(
	...
	'url'=> true,
	 ...
	 'readonly'=>false,
	 'required' => array('logo_favicon_opt1','=','1')
  ),
   array(
 'id'=>'logo_text',
 'type' => 'text', 
 'customizer' => true,
 'title' => __('Logo Text', 'panoply'),
 'subtitle'=> __('Enter logo text (max 6 - 8 characters)', 'panoply'),
 "default"       => '',
 'required' => array('logo_favicon_opt1','!=','1')	
 ),
...
/*array(
 ...
 'type' => 'color', 
 'customizer' => true,
 'title' => __('Logo span tag text color', 'panoply'),

 'subtitle'=> __('Enter span tag text color', 'panoply'),
 "default"       => '',
 'required' => array('logo_favicon_opt1','!=','1')	
 ),*/

  array(
    'id'          => 'logo_favicon_optn4',
    'type'        => 'typography', 
    'title'       => __('Logo Typography', 'panoply'),
    'google'      => true, 
    'font-backup' => false,
	'text-align' => false,
    'output'      => array('.logo h1'),
    'units'       =>'px',
    'subtitle'    => __('Select your prefered font Size (84px) for logo', 'panoply'),
    'default'     => array(
        'color'       => '#fff', 
        'font-style'  => '500', 
...
'required' => array('logo_favicon_opt1','!=','1')
 ...
 'id'       => 'logo_tagline',
     'type'     => 'switch',
     'title'    => __('Logo Tagline', 'panoply'), 
      'subtitle' => __('Enable or Disable logo tagline', 'panoply'),
      'default' => '1'
 ),
     array(
 ...
 'type' => 'text', 
 'customizer' => true,
 'title' => __('Logo Tagline Text', 'panoply'),
 'subtitle'=> __('Enter logo text (max 45 - 53 characters)', 'panoply'),
 "default"       => '',
 'required' => array('logo_tagline','=','1')
 ),
 array(
 'id'=>'tagline_color2',
 'type' => 'color', 
 ...
 'customizer' => true,
'transparent' => false,
 'title' => __('Logo Tagline Color', 'panoply'),
 'subtitle' => __('Select logo tagline color', 'panoply'),
'required' => array('logo_tagline','=','1')
),*/
 array(
     'id'       => 'retina_logo_type',
     'type'     => 'radio',
     'title'    => __('Retina Logo Type', 'panoply'), 
	  'class'     => 'select_style',
     'subtitle' => __('Select whether you want your Retina logo to be an image or text', 'panoply'),
       'options'  => array(
         '1' => __('Image','panoply'),  
         '2' => __('Text Logo', 'panoply'), 
      ),
 ...
 'type' => 'text', 
 'customizer' => true,
 'title' => __('Retina Logo Text', 'panoply'),
 'subtitle'=> __('Enter Retina logo text (max 10 - 14 characters)', 'panoply'),
 "default"       => '',
 'required' => array('retina_logo_type','=','2')
 ),
  array(
    'id'          => 'logo_favicon_optnrat',
    'type'        => 'typography', 
    'title'       => __('Logo Typography', 'panoply'),
    'google'      => true, 
    'font-backup' => false,
	'text-align' => false,
    'output'      => array('.sticky-nav .logo h1'),
    'units'       =>'px',
    'subtitle'    => __('Select your prefered font Size (84px) for logo', 'panoply'),
    'default'     => array(
        'color'       => '#fff', 
...
'required' => array('retina_logo_type','=','2')
 ...
 /*array(
 'id'=>'retina_logo_text_color',
 'type' => 'color', 
 'customizer' => true,
 'title' => __('Retina span tag text Color', 'panoply'),
 'subtitle'=> __('Enter span tag text color', 'panoply'),
 "default"       => '',
 'required' => array('retina_logo_type','=','2')	
 ),*/
