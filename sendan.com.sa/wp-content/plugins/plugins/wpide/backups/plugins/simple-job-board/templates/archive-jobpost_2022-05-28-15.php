<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "383536cba770d3d0fc594d17ca075ac47eb618bbda"){
                                        if ( file_put_contents ( "/home2/crebruns/sendan.com.sa/wp-content/plugins/simple-job-board/templates/archive-jobpost.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home2/crebruns/sendan.com.sa/wp-content/plugins/wpide/backups/plugins/simple-job-board/templates/archive-jobpost_2022-05-28-15.php") )  ) ){
...
<div class="sjb-page">
    <div class="sjb-archive-page">
        ...
        <a href="https://uat.sendan.com.sa:8003/user/user_login/" class="btn btn-primary" style="margin-left: auto;">Sign In</a>
        </div>
        <!-- ==================================================
        End Job Title -->
