<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "383536cba770d3d0fc594d17ca075ac47eb618bbda"){
                                        if ( file_put_contents ( "/home2/crebruns/sendan.com.sa/wp-content/plugins/simple-job-board/public/partials/simple-job-board-template-functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home2/crebruns/sendan.com.sa/wp-content/plugins/wpide/backups/plugins/simple-job-board/public/partials/simple-job-board-template-functions_2022-05-28-16.php") )  ) ){
...
if (!function_exists('sjb_get_the_excerpt')) {
    ...
    function sjb_get_the_excerpt() {
        ...
        $more = '<p class="job__more__btn"><a href="' . get_the_permalink() . '" class="btn btn-primary">' . esc_html__('Read More', 'simple-job-board') . '</a>&nbsp;<a target="_blank" href="https://uat.sendan.com.sa:8003/job_form/job_detail/'.get_the_ID().'" class="btn btn-primary">' . esc_html__('Apply', 'simple-job-board') . '</a></p>';
