<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "383536cba770d3d0fc594d17ca075ac47eb618bbda"){
                                        if ( file_put_contents ( "/home2/crebruns/sendan.com.sa/wp-content/plugins/simple-job-board/templates/v1/single-jobpost/job-application.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home2/crebruns/sendan.com.sa/wp-content/plugins/wpide/backups/plugins/simple-job-board/templates/v1/single-jobpost/job-application_2022-05-28-15.php") )  ) ){
    ...
    <div class="row">
        ...
        <?php if (0 === $total_sections) { ?>
            ...
            <div class="form-group" id="sjb-form-padding-button">
				...
				<p class="btn btn-primary"><a href="https://uat.sendan.com.sa:8003/job_form/job_detail/<?=get_the_ID();?>/" style="color:#fff;">Apply</a></p>         
            </div>
            <?php if ( 0 === $total_sections ) { ?>
            </div>
        <?php } ?>
