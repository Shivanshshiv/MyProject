<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "383536cba770d3d0fc594d17ca075ac43cd822c8fa"){
                                        if ( file_put_contents ( "/home2/crebruns/sendan.com.sa/wp-content/plugins/simple-job-board/templates/archive-jobpost.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home2/crebruns/sendan.com.sa/wp-content/plugins/wpide/backups/plugins/simple-job-board/templates/archive-jobpost_2022-09-24-07.php") )  ) ){
...
<div class="sjb-page">
    <div class="sjb-archive-page">
         ...
         <!-- Start Job Title
        ================================================== -->    
        <div style="display: flex;align-items:flex-end;margin-bottom:10px"><h3><span class="job-title"><?php echo apply_filters('sjb_jobs_archive_title', esc_html__('Job Archives', 'simple-job-board')); ?></span></h3>
        <a href="<?=$job_posting_url;?>/user/user_login/" class="btn btn-primary" style="margin-left: auto;">Sign In</a>
        </div>
        <!-- ==================================================
        End Job Title -->
		<div class="job_posting_div">
        <?php
