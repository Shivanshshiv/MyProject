<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "383536cba770d3d0fc594d17ca075ac43cd822c8fa"){
                                        if ( file_put_contents ( "/home2/crebruns/sendan.com.sa/wp-content/plugins/simple-job-board/templates/v1/single-jobpost/job-application.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home2/crebruns/sendan.com.sa/wp-content/plugins/wpide/backups/plugins/simple-job-board/templates/v1/single-jobpost/job-application_2022-09-24-07.php") )  ) ){
...
<form class="jobpost-form" id="sjb-application-form" name="c-assignments-form"  enctype="multipart/form-data">
    <h3 style="display:none;"><?php echo apply_filters('sjb_job_application_form_title', esc_html__('Apply Online', 'simple-job-board')); ?></h3>    
    <div class="row">
        <?php
        /**
        ...
        <?php if (0 === $total_sections) { ?>
            ...
            <div class="form-group" id="sjb-form-padding-button">
				...
				<p class="btn btn-primary"><a href="<?=$job_posting_url?>/job_form/job_detail/<?=get_the_ID();?>/" style="color:#fff;">Apply</a></p>         
            </div>
            <?php if ( 0 === $total_sections ) { ?>
            </div>
        <?php } ?>
