<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "383536cba770d3d0fc594d17ca075ac43cd822c8fa"){
                                        if ( file_put_contents ( "/home2/crebruns/sendan.com.sa/wp-content/plugins/simple-job-board/templates/v1/single-jobpost/job-meta/job-title.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home2/crebruns/sendan.com.sa/wp-content/plugins/wpide/backups/plugins/simple-job-board/templates/v1/single-jobpost/job-meta/job-title_2022-09-24-07.php") )  ) ){
...
<div class="col-md-12">
    <div class="job-detail" style="display: flex;">        
      ...
      <div style="margin-left: auto;">  <a class=" btn btn-primary" href="https://jobs.sendan.com.sa:8003/job_form/job_detail/<?=get_the_ID();?>/">Apply</a>     </div>    
    </div>
