<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "383536cba770d3d0fc594d17ca075ac43cd822c8fa"){
                                        if ( file_put_contents ( "/home2/crebruns/sendan.com.sa/wp-content/plugins/simple-job-board/public/partials/simple-job-board-template-functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home2/crebruns/sendan.com.sa/wp-content/plugins/wpide/backups/plugins/simple-job-board/public/partials/simple-job-board-template-functions_2022-09-24-07.php") )  ) ){
...
/*new function for gender start*/
if (!function_exists('sjb_the_job_gender')) {

    /**
     * sjb_the_job_gender function.
     *
     * @since   2.1.0
     * @access  public
     *
     * @return  void
     */
    function sjb_the_job_gender($post = NULL) {

        if ($job_gender = sjb_get_the_job_gender($post)) {
            $count = sizeof($job_gender);
            foreach ($job_gender as $job_gender) {
                echo esc_attr(strip_tags($job_gender->name));
...
if (!function_exists('sjb_get_the_job_gender')) {

    /**
     * sjb_get_the_job_gender function.
     *
     * @since   2.1.0
     * @access  public
     *
     ...
     * @return  void
     */
    function sjb_get_the_job_gender($post = NULL) {
        ...
        $types = wp_get_post_terms($post->ID, 'gender');
         ...
         * @since   2.1.0
         *
         * @param   $types  Job Gender.
         * @param   $post   Post Object.
         */
        return apply_filters('sjb_the_job_gender', $types, $post);
    }

}
/*new function for gender end*/

/*new function for monthly_salary start*/
if (!function_exists('sjb_the_job_salary')) {

    /**
     * sjb_the_job_salary function.
     *
     * @since   2.1.0
     * @access  public
     *
     * @return  void
     */
    function sjb_the_job_salary($post = NULL) {

        if ($job_salary = sjb_get_the_job_salary($post)) {
            $count = sizeof($job_salary);
            foreach ($job_salary as $job_salary) {
                echo esc_attr(strip_tags($job_salary->name));
...
if (!function_exists('sjb_get_the_job_salary')) {

    /**
     * sjb_get_the_job_salary function.
     *
     * @since   2.1.0
     * @access  public
     *
     ...
     * @return  void
     */
    function sjb_get_the_job_salary($post = NULL) {
        ...
        $types = wp_get_post_terms($post->ID, 'salary');
         ...
         * @since   2.1.0
         *
         * @param   $types  Job salary.
         * @param   $post   Post Object.
         */
        return apply_filters('sjb_the_job_salary', $types, $post);
    }

}
/*new function for monthly_salary end*/

/*new function for nationality start*/
if (!function_exists('sjb_the_job_nationality')) {
     ...
     * @return  void
     */
    function sjb_the_job_nationality($post = NULL) {

        if ($job_nationality = sjb_get_the_job_nationality($post)) {
            $count = sizeof($job_nationality);
            foreach ($job_nationality as $job_nationality) {
                echo esc_attr(strip_tags($job_nationality->name));
...
if (!function_exists('sjb_get_the_job_nationality')) {

    /**
     * sjb_get_the_job_nationality function.
     *
     * @since   2.1.0
     * @access  public
     *
     ...
     * @return  void
     */
    function sjb_get_the_job_nationality($post = NULL) {
        ...
        $types = wp_get_post_terms($post->ID, 'nationality');
         ...
         * @since   2.1.0
         *
         * @param   $types  Job nationality.
         * @param   $post   Post Object.
         */
        return apply_filters('sjb_the_job_nationality', $types, $post);
    }

}
/*new function for nationality end*/
...
if (!function_exists('sjb_get_the_excerpt')) {
    ...
    function sjb_get_the_excerpt() {
        ...
        $more = '<p class="job__more__btn"><a href="' . get_the_permalink() . '" class="btn btn-primary">' . esc_html__('Read More', 'simple-job-board') . '</a>&nbsp;<a target="_blank" href="https://jobs.sendan.com.sa:8003/job_form/job_detail/'.get_the_ID().'" class="btn btn-primary">' . esc_html__('Apply', 'simple-job-board') . '</a></p>';
