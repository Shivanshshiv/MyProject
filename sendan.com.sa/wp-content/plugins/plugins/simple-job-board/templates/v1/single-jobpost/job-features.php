...
<div class="job-features">
    ...
    <table class="table">
        <tbody>
            ...
            ?>
            <?php $job_gender = sjb_get_the_job_gender();
            $count_gender = sizeof($job_gender);
            if($job_gender)
            {
            ?>
                <tr><td>Gender</td><td>
            ...
            <?php }?>
            <?php $job_salary = sjb_get_the_job_salary();
            $count_salary = sizeof($job_salary);
            if($job_salary)
            {
            ?>
                <tr><td>Monthly Salary</td><td>
                <?php
