...
if (!function_exists('sjb_get_the_excerpt')) {
    ...
    function sjb_get_the_excerpt() {
        ...
        $more = '<p class="job__more__btn"><a href="' . get_the_permalink() . '" class="btn btn-primary">' . esc_html__('Read More', 'simple-job-board') . '</a>&nbsp;<a target="_blank" href="'. $job_posting_url.'/job_form/job_detail/'.get_the_ID().'" class="btn btn-primary">' . esc_html__('Apply', 'simple-job-board') . '</a></p>';
