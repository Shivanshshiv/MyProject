 ...
 *
 * @author EasePress Team <themes@easepress.com>
 * @link    http://easepress.com
 * @version 1.0.0
...
class CPT
{
     ...
     */
    public $textdomain = SENDAN_THEME_SLUG;
                    ...
                    if (is_array($this->taxonomies))
                    {
                        ...
                        foreach ($this->taxonomies as $tax)
                        {
                            ...
                            if ($tax !== 'category' && $tax !== 'post_tag')
                            {
                                ...
                                $new_columns[$tax] = sprintf(__('%s', $this->textdomain) , $taxonomy_object
                                    ->labels
                                    ->name);
                            }
                        }
        ...
        switch ($column)
        {
            ...
            case (taxonomy_exists($column)):
                ...
                else
                {
                    ...
                    // Echo no terms.
                    printf(__('No %s', $this->textdomain) , $taxonomy_object
                        ->labels
                        ->name);
                }
    ...
    function menu_icon($icon = "dashicons-admin-page")
    {
        ...
        if ((is_string($icon) && stripos($icon, "dashicons") !== false) || filter_var($icon, FILTER_VALIDATE_URL))
        {
