            ...
            <div class="col-sm-6" align="right">
                <form method="GET" action="<?php echo site_url() ?>/our-project/">
                    <div id="example_filter" class="dataTables_filter">
                        <label>Search:
                            <input type="hidden" name="term_slug" value="<?php echo $sector_cat_slug;  ?>" >
                            <input type="search" name="search-text"  value="" class="form-control input-sm" placeholder="" aria-controls="example">
                        </label>
                    </div>
                </form>
            </div>
